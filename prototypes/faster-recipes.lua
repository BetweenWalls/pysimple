...
local recipe_speed_multipliers = {
    ...
    ["ethylene-from-fruit"] = 2,
    ["plutonium-shuffle-1"] = 4,
    ["plutonium-shuffle-2"] = 4,
    ["plutonium-shuffle-3"] = 4,
    ["plutonium-shuffle-4"] = 4,
    ...
    ["print-fat"] = 2,
    ["print-brain"] = 2,
    ["xenogenic-from-meat"] = 2,
    ["xenogenic-from-fat"] = 2,
    ["plasmid-xenogenic-from-meat"] = 2,
    ["plasmid-xenogenic-from-fat"] = 2,
    ["gh-xenogenic-from-meat"] = 2,
    ["gas-bladder-to-co2"] = 4,
    ["gas-bladder-to-acetylene"] = 2,
    ["gas-bladder-to-methane"] = 2,
    ["gas-bladder-to-ammonia"] = 2,
    ["biomass-bones"] = 2,
    ["biomass-bonemeal"] = 2,
    ["biomass-skin"] = 2,
    ["biomass-meat"] = 2,
    ...
    ["biomass-lard"] = 2,
    ["biomass-blood"] = 2,
    ["biomass-arthropod-blood"] = 2,
    ["biomass-dried-meat"] = 2,
    ["biomass-biocrud"] = 2,
    -- metals:
    ["steel-plate"] = 2,
    ["iron-plate"] = 2,
    ...
    {names={"breed-fish-2", "breed-fish-2-agressive-selection"}, mult=1.5},
    ...
    {names={"ex-blo-auog", "ex-bon-auog", "ex-bra-auog", "ex-fat-auog", "ex-gut-auog", "ex-me-auog", "ex-ski-auog"}, mult=3},
    {names={"ralesia-1", "ralesia-1-hydrogen-burn"}, mult=4},
    {names={"ralesia-2", "ralesia-2-hydrogen-burn"}, mult=2.5},
    {names={"ralesia-3", "ralesia-3-hydrogen-burn"}, mult=1.8},
    ...
    {names={"ex-blo-cot", "ex-bon-cot", "ex-bra-cot", "ex-fat-cot", "ex-gut-cot", "ex-me-cot", "ex-ski-cot"}, mult=3},
    ...
    {names={"ex-blo-ulr", "ex-bon-ulr", "ex-bra-ulr", "ex-fat-ulr", "ex-gut-ulr", "ex-me-ulr", "ex-ski-ulr"}, mult=3},
    ...
    {names={"ex-blo-kor", "ex-bon-kor", "ex-bra-kor", "ex-fat-kor", "ex-gut-kor", "ex-me-kor", "ex-ski-kor"}, mult=3},
    {names={"sea-sponge-sprouts-flagellum", "sea-sponge-sprouts-2-flagellum", "sea-sponge-sprouts-3-flagellum", "sea-sponge-sprouts-4-flagellum"}, mult=2},
    {names={"zipir-eggs-1", "zipir-eggs-1-trits-gen"}, mult=3},
    {names={"zipir-eggs-2", "zipir-eggs-2-trits-gen"}, mult=2.33},
    {names={"zipir-eggs-3", "zipir-eggs-3-trits-gen"}, mult=1.5},
    {names={"zipir-a-1", "zipir-a-1-suicide"}, mult=3},
    {names={"zipir-a-2", "zipir-a-2-suicide"}, mult=2.6},
    {names={"zipir-a-3", "zipir-a-3-suicide"}, mult=2.2},
    {names={"zipir-a-4", "zipir-a-4-suicide"}, mult=1.8},
    {names={"zipir-a-5", "zipir-a-5-suicide"}, mult=1.4},
    {names={"full-render-zipir", "full-render-zipir-lard", "full-render-zipir-laser", "full-render-zipir-music"}, mult=3},
    {names={"ex-blo-zipir", "ex-bra-zipir", "ex-fat-zipir", "ex-gut-zipir", "ex-me-zipir", "ex-ski-zipir"}, mult=2},
    ["xyhiphoe-single"] = 3,
    {names={"full-render-xyhiphoe", "full-render-xyhiphoe-lard", "full-render-xyhiphoe-laser", "full-render-xyhiphoe-music"}, mult=3},
    {names={"ex-blo-xyh", "ex-gut-xyh", "ex-me-xyh"}, mult=2},
    ["yotoi-fruit-1"] = 2,
    {names={"yotoi-fruit-2", "yotoi-fruit-2-nutrient"}, mult=1.3},
    {names={"yotoi-fruit-3", "yotoi-fruit-3-nutrient"}, mult=1.25},
    {names={"yotoi-1", "yotoi-1-free-leaves"}, mult=4},
    {names={"yotoi-2", "yotoi-2-free-leaves", "yotoi-2-nutrient"}, mult=2},
    {names={"yotoi-3", "yotoi-3-free-leaves", "yotoi-3-nutrient"}, mult=1.5},
    {names={"rennea-1", "rennea-1-deadhead", "rennea-1-hydrophile"}, mult=4},
    {names={"rennea-2", "rennea-2-deadhead", "rennea-2-hydrophile"}, mult=2.5},
    {names={"rennea-3", "rennea-3-deadhead", "rennea-3-hydrophile"}, mult=1.66},
    ...
    {names={"ex-blo-muk", "ex-bon-muk", "ex-bra-muk", "ex-fat-muk", "ex-gut-muk", "ex-me-muk", "ex-ski-muk"}, mult=3},
    {names={"cadaveric-arum-1", "cadaveric-arum-1-soil", "cadaveric-arum-1-msa"}, mult=4},
    {names={"cadaveric-arum-2", "cadaveric-arum-2-soil", "cadaveric-arum-2-msa"}, mult=2.5},
    ...
    {names={"full-render-phagnots", "full-render-phagnots-lard", "full-render-phagnots-laser", "full-render-phagnots-music"}, mult=6},
    {names={"ex-blo-phag", "ex-bon-phag", "ex-bra-phag", "ex-gut-phag", "ex-me-phag", "ex-ski-phag"}, mult=3},
    ...
    {names={"ex-blo-art", "ex-bon-art", "ex-bra-art", "ex-fat-art", "ex-gut-art", "ex-me-art", "ex-ski-art"}, mult=2},
    ...
    {names={"ex-blo-scro", "ex-bon-scro", "ex-bra-scro", "ex-fat-scro", "ex-gut-scro", "ex-me-scro", "ex-ski-scro", "scrondrix-brain-slaughterhouse-ex"}, mult=3},
    ...
    {names={"ex-blo-din", "ex-bon-din", "ex-bra-din", "ex-gut-din", "ex-me-din", "ex-pelt-din"}, mult=3},
    {names={"kmauts-cub-1", "kmauts-cub-1-ratio", "kmauts-cub-1-eye-out"}, mult=2},
    {names={"kmauts-cub-2", "kmauts-cub-2-ratio", "kmauts-cub-2-eye-out"}, mult=1.66},
    {names={"kmauts-cub-3", "kmauts-cub-3-ratio", "kmauts-cub-3-eye-out"}, mult=1.33},
    {names={"kmauts-1", "kmauts-1-ratio"}, mult=2},
    {names={"kmauts-2", "kmauts-2-ratio"}, mult=1.66},
    {names={"kmauts-3", "kmauts-3-ratio"}, mult=1.33},
    {names={"full-render-kmauts", "full-render-kmauts-lard", "full-render-kmauts-laser", "full-render-kmauts-music"}, mult=2},
    ["phadai-pup-1"] = 3,
    ["phadai-pup-2"] = 2.66,
    ["phadai-pup-3"] = 2.33,
    ["phadai-pup-4"] = 2,
    ...
    {names={"ex-blo-sim", "ex-bon-sim", "ex-bra-sim", "ex-fat-sim", "ex-gut-sim", "ex-me-sim"}, mult=2},
    {names={"full-render-num", "full-render-num-lard", "full-render-num-laser", "full-render-num-music"}, mult=3},
    {names={"ex-blo-num", "ex-gut-num", "ex-me-num", "ex-ski-num"}, mult=2},
    ...
    {names={"ex-blo-von", "ex-bra-von", "ex-fat-von", "ex-gut-von", "ex-me-von", "ex-ski-von"}, mult=2},
    ...
    {names={"quantum-dots-folding-1", "quantum-dots-folding-2", "quantum-dots-folding-3", "quantum-dots-folding-4"}, mult=8},
}
...
local building_energy_multipliers = {
    ["assembling-machine"] = {
        ...
        ["rhe"] = 3,
        {names={"slaughterhouse-mk01", "slaughterhouse-mk02", "slaughterhouse-mk03", "slaughterhouse-mk04"}, mult=3},
        ...
        ["ez-ranch-mk03"] = 1.05,
        ["zipir-reef-mk01"] = 3,
        ["zipir-reef-mk02"] = 1.25,
        ["zipir-reef-mk03"] = 1.07,
        ["yotoi-aloe-orchard-mk01"] = 3,
        ["yotoi-aloe-orchard-mk02"] = 1.66,
        ["yotoi-aloe-orchard-mk03"] = 1.2,
        ["rennea-plantation-mk01"] = 2,
        ["rennea-plantation-mk02"] = 1.33,
        ["rennea-plantation-mk03"] = 1.1,
        ["grods-swamp-mk01"] = 2,
        ...
        ["kmauts-enclosure-mk01"] = 2,
        ["kmauts-enclosure-mk02"] = 1.33,
        ["kmauts-enclosure-mk03"] = 1.1,
        ["vonix-den-mk01"] = 2,
        ["vonix-den-mk02"] = 1.33,
        ["vonix-den-mk03"] = 1.1,
        ["zungror-lair-mk01"] = 2,
        ...
        ["xenopen-mk02"] = 1.66,
        ["xenopen-mk03"] = 1.16,
        -- misc changes unrelated to recipe speed increases:
        ["hydroclassifier-mk03"] = 1.5,
        ["carbon-filter-mk03"] = 1.05,
        ["compressor-mk02"] = 2,
        ["compressor-mk03"] = 1.5,
        ["compressor-mk04"] = 1.33,
        ["olefin-plant-mk02"] = 1.5,
        ["olefin-plant-mk03"] = 1.33,
        ["olefin-plant-mk04"] = 1.25,
        ["desulfurizator-unit-mk02"] = 1.2,
        ["desulfurizator-unit-mk03"] = 1.15,
        ["centrifuge-mk01"] = 1.6,
        ["centrifuge-mk02"] = 1.4,
        ["centrifuge-mk03"] = 1.2,
        ["mukmoux-pasture-mk03"] = 0.6,
    },
}
