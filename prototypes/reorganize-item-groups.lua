...
local groups = {
    ["logistics"] = {
        ...
        ["py-tiles-2"] = {items={"roboport"}},
        ["py-asphalt-mk03"] = {"black-refined-concrete", "brown-refined-concrete", "pink-refined-concrete", "purple-refined-concrete", "red-refined-concrete", "orange-refined-concrete", "yellow-refined-concrete", "acid-refined-concrete", "green-refined-concrete", "cyan-refined-concrete", "blue-refined-concrete"},
    },
    ["production"] = {
        ...
        ["py-mining-mk02"] = {order="zpy[mk02]-b[extraction]", items={"flora-collector-mk02", "soil-extractor-mk02", "clay-pit-mk02", "fluid-drill-mk02", "borax-mine-mk02", "antimony-drill-mk02", "ree-mining-drill-mk02", "natural-gas-derrick-mk02", "oil-derrick-mk02", "oil-sand-extractor-mk02", "tar-extractor-mk02", "coalbed-mk02", "pumpjack-mk02", "sand-extractor-mk02", "ground-borer-mk02", "spore-collector-mk02", "tholin-atm-mk02", "soil-extractor-mk02-legacy", "antimonium-drill-mk02", "ground-borer-mk02-legacy", "sand-extractor-mk02-legacy", "natural-gas-derrick-mk02-base", "oil-derrick-mk02-base", "tar-extractor-mk02-base"}},
    ...
    ["py-hightech"] = { -- renamed "intermediate products"
        ...
        ["py-intermediates-34b"] = {order="zpy-49b", items={"sodium-acetate", "fecl2", "fecl3", "nylon-rope", "nylon-rope-coated", "nylon-rope-uranyl-soaked", "uranyl-nitrate"}},
        ["py-nuclear"] = {order="zpy-50", items={"po-210", "pa-233", "americium-oxide", "am-241", "am-243", "uranium-oxide", "u-232", "u-233", "u-234", "u-235", "uranium-235", "u-236", "u-237", "u-238", "uranium-238", "plutonium-oxide", "plutonium-oxide-mox", "pu-238", "pu-239", "pu-240", "pu-241", "pu-242", "cm-250", "plutonium", "vitrified-glass"}, recipes={"uranium-processing"}},
        ["recipe-py-nuclear"] = {order="zpy-50"},
        ["py-nuclear-waste"] = {order="zpy-50b"},
        ["recipe-py-nuclear-waste"] = {order="zpy-50b"},
        ...
        ["uranium-processing"] = {order="zpy-51b"},
        ...
        ["py-intermediates-40"] = {order="zpy-56", items={"barrel", "empty-fuel-canister", "empty-gas-canister", "methanol-gas-canister", "empty-proto-tholins-vessel", "filled-proto-tholins-vessel", "filled-tholins-vessel"}, recipes={"empty-methanol-gas-canister", "barrel-milk", "empty-milk-barrel", "empty-proto-tholins-vessel", "fill-proto-tholins-vessel", "empty-tholins-vessel"}},
    ...
    ["py-petroleum-handling"] = { -- renamed "fluids"
        ["py-fluids-1"] = {order="zpy-01", items={"void", "combustion-mixture1", "hot-reaction-gas", "processed-light-oil"}, recipes={"advanced-oil-processing", "coal-liquefaction"}},
        ...
        ["py-fluids-4"] = {order="zpy-04", items={"water", "water-saline", "pressured-water", "subcritical-water", "geothermal-water", "waste-water", "dirty-water-light"}, recipes={"tar-quenching"}},
        ...
        ["py-fluids-11"] = {order="zpy-11", items={"tar"}},
        ["py-fluids-12"] = {order="zpy-12", items={"pitch", "middle-oil", "anthracene-oil", "naphthalene-oil", "carbolic-oil", "creosote", "dirty-water-heavy"}, recipes={{"tar-refining","zpy-item-00b"}, {"pitch-refining","zpy-item-00c"}, {"tar-refining-tops","zpy-item-02b"}}},
        ["py-fluids-13"] = {order="zpy-13", items={"slacked-lime", "acetylene"}},
        ["py-fluids-14"] = {order="zpy-14", items={"tall-oil", "aromatics", "polybutadiene", "black-liquor"}},
        ...
        ["py-fluids-17"] = {order="zpy-17", items={"carbon-dioxide", "nickel-carbonyl"}},
    ...
    ["py-alienlife"] = { -- renamed "life"
        ["py-alienlife-buildings-mk00"] = {items={"slaughterhouse-mk00", "atomizer-mk00", "compost-plant-mk00"}},
        ...
        ["py-alienlife-buildings-others"] = {items={"data-array", "simik-boiler", "generator-1", "generator-1-turd", "generator-2", "pyphoon-bay", "outpost", "outpost-aerial", "pydrive", "ipod", "dino-dig-site", "mega-farm", "harvester", "antelope-enclosure-mk01", "pipette-dino-dig-site", "dino-dig-site-food-input"}},
        ...
        ["py-alienlife-used"] = {order="ba-3", items={"used-auog", "used-auog-mk02", "used-auog-mk03", "used-auog-mk04", "used-ulric", "used-ulric-mk02", "used-ulric-mk03", "used-ulric-mk04", "used-dingrit", "used-dingrit-mk02", "used-dingrit-mk03", "used-dingrit-mk04", "used-simik", "used-simik-mk02", "used-simik-mk03", "used-simik-mk04", "used-phadai"}},
        ["py-alienlife-replicators"] = {order="ba-4", items={"replicator-bioreserve", "replicator-ralesia", "replicator-kicalk", "replicator-tuuphra", "replicator-rennea", "replicator-yotoi", "replicator-yotoi-fruit", "replicator-grod", "replicator-cadaveric-arum", "replicator-mova"}},
        ["py-alienlife-items"] = {items={{"biocarnation","7"}, {"biocrud","8"}, {"rich-biocrud","9"}, {"cage","a"}, "ulric-infusion", "ulric-infusion-equipment", "energy-drink", "dried-meat", "seeds-extract-01", "syrup-01", "bedding", "sporopollenin", "cellulose", "lignin", "fungal-substrate", "fungal-substrate-02", "fungal-substrate-03", "urea", "guano", "ammonium-nitrate", "manure", "liquid-manure", "depolymerized-organics", "manure-bacteria", "zogna-bacteria", "fertilizer", "guar-gum", "stone-wool", "raw-fiber", "fiber", "powdered-ralesia-seeds", "starch", "blood-meal", "albumin", "sugar", "sodium-alginate", "creamy-latex", "formic-acid", "latex-slab", "myoglobin", "resilin", "casein", "alcl3", "fungicide", "mcb", "chloral", "pre-pesticide-01", "pesticide-mk01", "ethyl-mercaptan", "dda", "pre-pesticide-02", "pesticide-mk02", "nano-cellulose", "magnetic-beads", "hmas", "empty-neuromorphic-chip", "neuromorphic-chip", "neuroprocessor", "pheromones", "perfect-samples"}, recipes={{"cage-recycle-into-titanium", "ab"}, {"biocarnation-harvesting", "7b"}, {"biocrud-reprocessing", "8b"}, {"rich-biocrud-reprocessing", "9b"}}},
        ...
        ["py-alienlife-codex"] = {items={"vrauks-codex", "auog-codex", "cottongut-codex", "ulric-codex", "arqad-codex", "korlex-codex", "mukmoux-codex", "phagnot-codex", "arthurian-codex", "scrondrix-codex", "dingrits-codex", "kmauts-codex", "phadai-codex", "simik-codex", "zungror-codex", "xeno-codex", "vonix-codex", "antelope-codex", "zipir-codex", "trits-codex", "xyhiphoe-codex", "dhilmos-codex", "numal-codex", "sea-sponge-codex", "cridren-codex", "moondrop-codex", "ralesia-codex", "fawogae-codex", "tuuphra-codex", "kicalk-codex", "yaedols-codex", "rennea-codex", "yotoi-codex", "navens-codex", "bhoddos-codex", "grod-codex", "cadaveric-arum-codex", "guar-codex", "bat-codex"}},
        ["py-alienlife-codex-mk02"] = {items={"zipir-codex-mk02", "trits-codex-mk02", "dhilmos-codex-mk02", "numal-codex-mk02", "korlex-codex-mk02", "mukmoux-codex-mk02", "scrondrix-codex-mk02", "dingrits-codex-mk02", "kmauts-codex-mk02", "phadai-codex-mk02", "simik-codex-mk02", "zungror-codex-mk02", "xeno-codex-mk02", "vonix-codex-mk02"}},
        ["py-alienlife-codex-mk03"] = {items={"zipir-codex-mk03", "trits-codex-mk03", "dhilmos-codex-mk03", "numal-codex-mk03", "korlex-codex-mk03", "mukmoux-codex-mk03", "scrondrix-codex-mk03", "dingrits-codex-mk03", "kmauts-codex-mk03", "phadai-codex-mk03", "simik-codex-mk03", "zungror-codex-mk03", "xeno-codex-mk03", "vonix-codex-mk03"}},
        ["py-alienlife-codex-mk04"] = {items={"zipir-codex-mk04", "trits-codex-mk04", "dhilmos-codex-mk04", "numal-codex-mk04", "korlex-codex-mk04", "mukmoux-codex-mk04", "scrondrix-codex-mk04", "dingrits-codex-mk04", "kmauts-codex-mk04", "phadai-codex-mk04", "simik-codex-mk04", "zungror-codex-mk04", "xeno-codex-mk04", "vonix-codex-mk04"}},
        ["py-alienlife-vrauks"] = {order="e-a", items={"blood-caged-vrauks", "brain-caged-vrauks", "guts-caged-vrauks", "meat-caged-vrauks", "chitin-caged-vrauks", "caged-vrauks", "cocoon", "cocoon-mk02", "cocoon-mk03", "cocoon-mk04", "vrauks", "vrauks-mk02", "vrauks-mk03", "vrauks-mk04"}, recipes={{"full-render-vrauks",""}, {"ex-blo-vrauks"}, {"ex-bra-vrauks","a03"}, {"ex-gut-vrauks"}, {"ex-me-vrauks"}, {"ex-ski-vrauks"}}},
        ["py-alienlife-auog"] = {order="e-b", items={"blood-caged-auog", "bone-caged-auog", "brain-caged-auog", "fat-caged-auog", "guts-caged-auog", "meat-caged-auog", "skin-caged-auog", {"glandular-myocluster","b2"}, "caged-auog", "auog-pup", "auog-pup-mk02", "auog-pup-mk03", "auog-pup-mk04", "charged-auog", "auog", "auog-mk02", "auog-mk03", "auog-mk04"}, recipes={{"full-render-auogs","1"}, {"ex-used-auog","2"}, {"ex-used-auog-lard","2b"}, {"ex-used-auog-music","2c"}, {"ex-used-auog-laser","2d"}, {"ex-blo-auog"}, {"ex-bon-auog"}, {"ex-bra-auog","a05"}, {"ex-fat-auog"}, {"ex-gut-auog"}, {"ex-me-auog"}, {"ex-ski-auog"}, {"extract-auog-eye"}, "auog-pooping-1", "auog-pooping-2", "auog-pooping-3", "auog-pooping-4", "auog-pooping-5"}},
        ...
        ["py-alienlife-ulric"] = {order="e-d", items={"blood-caged-ulric", "bone-caged-ulric", "brain-caged-ulric", "fat-caged-ulric", "guts-caged-ulric", "meat-caged-ulric", "skin-caged-ulric", {"magnetic-organ","b2"}, "caged-ulric", "ulric-cub", "ulric-cub-mk02", "ulric-cub-mk03", "ulric-cub-mk04", "ulric", "ulric-mk02", "ulric-mk03", "ulric-mk04", "ulric-mk02-dna-sample", "ulric-mk03-dna-sample", "ulric-mk04-dna-sample", "sample-cup", "saddle"}, recipes={{"full-render-ulrics","1"}, {"ex-blo-ulr"}, {"ex-bon-ulr"}, {"ex-bra-ulr"}, {"ex-fat-ulr"}, {"ex-gut-ulr"}, {"ex-me-ulr"}, {"ex-ski-ulr"}, {"extract-ulric-eye"}, "ulric-manure-1", "ulric-manure-2", "ulric-manure-3", "ulric-manure-4"}},
        ["py-alienlife-arqad"] = {order="e-e", items={"blood-arqad", "guts-arqad", "meat-arqad", "chitin-arqad", {"sternite-lung","b"}, "arqad-egg-nest", "arqad-egg-nest-2", "arqad-egg-nest-3", "arqad-egg-nest-4", "arqad-egg", "arqad-egg-2", "arqad-egg-3", "arqad-egg-4", "arqad-maggot", "arqad-maggot-2", "arqad-maggot-3", "arqad-maggot-4", "arqad-queen", "arqad", "arqad-mk02", "arqad-mk03", "arqad-mk04", "empty-comb", "filled-comb", "wax", "wax-barrel", "empty-honeycomb", "honeycomb", "arqad-honey", "bee-venom", "arqad-propolis", "arqad-jelly-barrel", "arqad-jelly", "cags"}, recipes={{"full-render-arqads","1"}, {"ex-blo-arq"}, {"ex-gut-arq"}, {"ex-me-arq"}, {"ex-chi-arq"}}},
        ...
        ["py-alienlife-mukmoux"] = {order="e-g", items={"blood-caged-mukmoux", "bone-caged-mukmoux", "brain-caged-mukmoux", "fat-caged-mukmoux", "guts-caged-mukmoux", "meat-caged-mukmoux", "skin-caged-mukmoux", "caged-mukmoux", "mukmoux-calf", "mukmoux", "mukmoux-mk02", "mukmoux-mk03", "mukmoux-mk04"}, recipes={{"full-render-mukmoux","1"}, {"ex-blo-muk"}, {"ex-bon-muk"}, {"ex-bra-muk"}, {"ex-fat-muk"}, {"ex-gut-muk"}, {"ex-me-muk"}, {"ex-ski-muk"}, {"extract-mukmoux-eye"}, "mukmoux-manure-1", "mukmoux-manure-2", "mukmoux-manure-3", "mukmoux-manure-4", "mukmoux-manure-1-mukmoux-turd", "mukmoux-manure-2-mukmoux-turd", "mukmoux-manure-3-mukmoux-turd", "mukmoux-manure-4-mukmoux-turd"}},
        ["py-alienlife-phagnot"] = {order="e-h", items={"blood-caged-phagnot", "bone-caged-phagnot", "brain-caged-phagnot", "guts-caged-phagnot", "meat-caged-phagnot", {"geostabilization-tissue","b"}, "skin-caged-phagnot", "caged-phagnot", "phagnot-cub", "phagnot-cub-mk02", "phagnot-cub-mk03", "phagnot-cub-mk04", "phagnot", "phagnot-mk02", "phagnot-mk03", "phagnot-mk04", "gas-bladder"}, recipes={{"full-render-phagnots","1"}, {"ex-blo-phag"}, {"ex-bon-phag"}, {"ex-bra-phag"}, {"ex-gut-phag"}, {"ex-me-phag"}, {"ex-ski-phag"}}},
        ...
        ["py-alienlife-simik"] = {order="e-n", items={"blood-caged-simik", "bone-caged-simik", "brain-caged-simik", "fat-caged-simik", "guts-caged-simik", "meat-caged-simik", "skin-caged-simik", {"hormonal","b1"}, {"keratin","b2"}, {"simik-scales","b3"}, "caged-simik", "simik-pup", "simik", "simik-mk02", "simik-mk03", "simik-mk04", "simik-poop"}, recipes={{"full-render-simik","1"}, {"ex-blo-sim"}, {"ex-bon-sim"}, {"ex-bra-sim"}, {"ex-fat-sim"}, {"ex-gut-sim"}, {"ex-me-sim"}, {"ex-ski-sim"}}},
        ["py-alienlife-vonix"] = {order="e-o", items={"blood-vonix", "brain-vonix", "fat-vonix", "guts-vonix", "meat-vonix", "skin-vonix", "vonix-eggs", "vonix-cub", "vonix", "vonix-mk02", "vonix-mk03", "vonix-mk04", "venom-gland"}, recipes={{"full-render-vonix","1"}, {"ex-blo-von"}, {"ex-bra-von"}, {"ex-fat-von"}, {"ex-gut-von","af"}, {"ex-me-von"}, {"ex-ski-von"}}},
        ...
        ["py-alienlife-xeno"] = {order="e-q", items={"sulfuric-caged-xeno", "bone-caged-xeno", "brain-caged-xeno", "meat-caged-xeno", "chitin-caged-xeno", {"cognition-osteochain","b"}, "caged-xeno", "xeno-egg", "xeno", "xeno-mk02", "xeno-mk03", "xeno-mk04"}, recipes={{"full-render-xenos","1"}, {"ex-blo-xeno",}, {"ex-bon-xeno"}, {"ex-bra-xeno"}, {"ex-me-xeno"}, {"ex-chi-xeno"}}},
        ["py-alienlife-antelope"] = {order="e-r", items={"antelope", "anti-lope", "neutra-lope", "pos-tilope", "cage-antelope", "caged-antelope", "dimensional-gastricorg", "strangelets"}, recipes={{"full-render-antelope","1a"}, {"full-render-antelope-existential","1b"}, {"quantum-dots-folding-1","zpy-item-01x"}, {"quantum-dots-folding-2","zpy-item-02x"}, {"quantum-dots-folding-3","zpy-item-04x"}, {"quantum-dots-folding-4","zpy-item-03x"}}},
        ...
        ["py-alienlife-trits"] = {order="e-x[water]-2", items={"blood-trits", "bone-trits", "brain-trits", "fat-trits", "guts-trits", "meat-trits", "skin-trits", {"photophore","b"}, "trits-pup", "trits", "trits-mk02", "trits-mk03", "trits-mk04"}, recipes={{"full-render-trit","1"}, {"ex-blo-trit"}, {"ex-bon-trit"}, {"ex-bra-trit"}, {"ex-fat-trit"}, {"ex-gut-trit"}, {"ex-me-trit"}, {"ex-ski-trit"}}},
        ...
        ["py-alienlife-dhilmos"] = {order="e-x[water]-4", items={"blood-dhilmos", "fat-dhilmos", "guts-dhilmos", "meat-dhilmos", {"autoantigens","b"}, "dhilmos-egg", "dhilmos-pup", "dhilmos", "dhilmos-mk02", "dhilmos-mk03", "dhilmos-mk04"}, recipes={{"full-render-dhilmoss","1"}, {"ex-blo-dhi"}, {"ex-fat-dhi"}, {"ex-gut-dhi"}, {"ex-me-dhi"}, {"extract-dhilmos-eye"}}},
        ["py-alienlife-numal"] = {order="e-x[water]-5", items={"blood-numal", "guts-numal", "meat-numal", "skin-numal", "chitin-numal", {"aeroorgan","b"}, "numal-egg", "numal", "numal-mk02", "numal-mk03", "numal-mk04", "numal-ink"}, recipes={{"full-render-num","1"}, {"ex-blo-num"}, {"ex-gut-num"}, {"ex-gut-num-neodymium"}, {"ex-me-num"}, {"ex-ski-num"}}},
        ["py-alienlife-fish"] = {order="e-x[water]-6", items={"fish-egg", "fish-egg-mk02", "fish-egg-mk03", "fish-egg-mk04", "fish", "fish-mk02", "fish-mk03", "fish-mk04", "fish-oil", "fish-hydrolysate", "fishmeal", "fish-emulsion"}, recipes={{"full-render-fish","1"}}},
        ...
        ["py-alienlife-biosample"] = {order="f-a", items={"native-flora", "floraspollinin"}},
        ...
        ["py-alienlife-tree"] = {order="f-d", items={"tree-mk01", "tree-mk02", "tree-mk03", "tree-mk04", "wood-seedling", "wood-seedling-mk02", "wood-seedling-mk03", "wood-seedling-mk04", "wood-seeds", "wood-seeds-mk02", "wood-seeds-mk03", "wood-seeds-mk04", "log", "lacquer-resin", "py-sawblade-module-mk01", "py-sawblade-module-mk02", "py-sawblade-module-mk03", "py-sawblade-module-mk04"}},
        ...
        ["py-alienlife-moon"] = {order="f-f", items={"moondrop", "moondrop-mk02", "moondrop-mk03", "moondrop-mk04", "moondrop-seeds", "moondrop-seeds-mk02", "moondrop-seeds-mk03", "moondrop-seeds-mk04", "moondrop-fueloil", "moondrop-diesel", "moondrop-gas", "moondrop-kerosene"}},
        ["py-alienlife-ralesia"] = {order="f-g", items={"ralesia", "ralesia-mk02", "ralesia-mk03", "ralesia-mk04", "ralesia-seeds", "ralesia-seeds-mk02", "ralesia-seeds-mk03", "ralesia-seeds-mk04", "dry-ralesia", "ralesia-powder", "raw-ralesia-extract", "ralesia-extract", "paper-towel"}},
        ["py-alienlife-fawogae"] = {order="f-h", items={"fawogae", "fawogae-mk02", "fawogae-mk03", "fawogae-mk04", "fawogae-spore", "fawogae-spore-mk02", "fawogae-spore-mk03", "fawogae-spore-mk04"}},
        ["py-alienlife-tuuphra"] = {order="f-i", items={"tuuphra", "tuuphra-mk02", "tuuphra-mk03", "tuuphra-mk04", "tuuphra-seeds", "a-molasse", "b-molasse", "sweet-syrup"}},
        ["py-alienlife-kicalk"] = {order="f-j", items={"kicalk", "kicalk-mk02", "kicalk-mk03", "kicalk-mk04", "kicalk-seeds", "kicalk-seeds-mk02", "kicalk-seeds-mk03", "kicalk-seeds-mk04", "kicalk-dry"}},
        ["py-alienlife-yaedols"] = {order="f-k", items={"yaedols", "yaedols-mk02", "yaedols-mk03", "yaedols-mk04", "yaedols-spores", "yaedols-spores-mk02", "yaedols-spores-mk03", "yaedols-spores-mk04", "flavonoids"}},
        ["py-alienlife-rennea"] = {order="f-l", items={"rennea", "rennea-mk02", "rennea-mk03", "rennea-mk04", "rennea-seeds", "rennea-seeds-mk02", "rennea-seeds-mk03", "rennea-seeds-mk04", "digested-rennea-seeds-mk02", "digested-rennea-seeds-mk03", "digested-rennea-seeds-mk04", "abraded-rennea-seeds-mk02", "abraded-rennea-seeds-mk03", "abraded-rennea-seeds-mk04", "deadhead"}},
        ["py-alienlife-yotoi"] = {order="f-m", items={"yotoi", "yotoi-mk02", "yotoi-mk03", "yotoi-mk04", "yotoi-fruit", "yotoi-fruit-mk02", "yotoi-fruit-mk03", "yotoi-fruit-mk04", "yotoi-seeds", "yotoi-seeds-mk02", "yotoi-seeds-mk03", "yotoi-seeds-mk04", "yotoi-leaves", "nutrient"}},
        ["py-alienlife-navens"] = {order="f-n", items={"navens", "navens-mk02", "navens-mk03", "navens-mk04", "navens-spore", "navens-spore-mk02", "navens-spore-mk03", "navens-spore-mk04", "navens-abomination"}, recipes={"full-render-navens-abomination"}},
        ["py-alienlife-bhoddos"] = {order="f-o", items={"bhoddos", "bhoddos-mk02", "bhoddos-mk03", "bhoddos-mk04", "bhoddos-spore", "bhoddos-spore-mk02", "bhoddos-spore-mk03", "bhoddos-spore-mk04"}},
        ["py-alienlife-grod"] = {order="f-p", items={"grod", "grod-mk02", "grod-mk03", "grod-mk04", "grod-seeds-pod-mk02", "grod-seeds-pod-mk03", "grod-seeds-pod-mk04", "grod-seeds", "grod-seeds-mk02", "grod-seeds-mk03", "grod-seeds-mk04", "dried-grods"}},
        ["py-alienlife-cadaveric"] = {order="f-q", items={"cadaveric-arum", "cadaveric-arum-mk02-a", "cadaveric-arum-mk03-a", "cadaveric-arum-mk04-a", "cadaveric-arum-seeds", "cadaveric-arum-seeds-mk02", "cadaveric-arum-seeds-mk03", "cadaveric-arum-seeds-mk04", "cadaveric-arum-mk02-seed-juice", "cadaveric-arum-mk03-seed-juice", "cadaveric-arum-mk04-seed-juice", "residual-gas", "dms", "msa"}},
        ["py-alienlife-guar"] = {order="f-r", items={"guar", "guar-mk02", "guar-mk03", "guar-mk04", "guar-seeds", "guar-seeds-mk02", "guar-seeds-mk03", "guar-seeds-mk04"}},
        ["py-alienlife-mova"] = {order="f-s", items={"mova", "washed-mova", "mova-pulp1", "mova-pulp2", "mova-pulp3", "guaiacol", "buffer-solution", "pre-enzyme", "ammonium-sulfate", "crude-enzyme"}},
        ["recipe-py-alienlife-ulric"] = {order=data.raw["item-subgroup"]["py-alienlife-ulric"].order or "e-a"}, -- Note: These alternative order strings still use the previous unsorted values (shouldn't matter now that the orders for their "parent" subgroups are explicitly defined)
        ["recipe-py-alienlife-auog"] = {order=data.raw["item-subgroup"]["py-alienlife-auog"].order or "e-aa"},
        ["recipe-py-alienlife-mukmoux"] = {order=data.raw["item-subgroup"]["py-alienlife-mukmoux"].order or "e-b"},
        ["recipe-py-alienlife-vrauks"] = {order=data.raw["item-subgroup"]["py-alienlife-vrauks"].order or "e-ba"},
        ["recipe-py-alienlife-arthurian"] = {order=data.raw["item-subgroup"]["py-alienlife-arthurian"].order or "e-c"},
        ["recipe-py-alienlife-scrondrix"] = {order=data.raw["item-subgroup"]["py-alienlife-scrondrix"].order or "e-e"},
        ["recipe-py-alienlife-phadai"] = {order=data.raw["item-subgroup"]["py-alienlife-phadai"].order or "e-f"},
        ["recipe-py-alienlife-dingrits"] = {order=data.raw["item-subgroup"]["py-alienlife-dingrits"].order or "e-h"},
        ["recipe-py-alienlife-kmauts"] = {order=data.raw["item-subgroup"]["py-alienlife-kmauts"].order or "e-i"},
        ["recipe-py-alienlife-vonix"] = {order=data.raw["item-subgroup"]["py-alienlife-vonix"].order or "e-j"},
        ["recipe-py-alienlife-phagnot"] = {order=data.raw["item-subgroup"]["py-alienlife-phagnot"].order or "e-k"},
        ["recipe-py-alienlife-xeno"] = {order=data.raw["item-subgroup"]["py-alienlife-xeno"].order or "e-l"},
        ["recipe-py-alienlife-simik"] = {order=data.raw["item-subgroup"]["py-alienlife-simik"].order or "e-qb"},
        ["recipe-py-alienlife-korlex"] = {order=data.raw["item-subgroup"]["py-alienlife-korlex"].order or "e-r"},
        ["recipe-py-alienlife-cottongut"] = {order=data.raw["item-subgroup"]["py-alienlife-cottongut"].order or "e-s"},
        ["recipe-py-alienlife-arqad"] = {order=data.raw["item-subgroup"]["py-alienlife-arqad"].order or "e-t"},
        ["recipe-py-alienlife-zungror"] = {order=data.raw["item-subgroup"]["py-alienlife-zungror"].order or "e-v"},
        ["recipe-py-alienlife-antelope"] = {order=data.raw["item-subgroup"]["py-alienlife-antelope"].order or "e-w"},
        ["recipe-py-alienlife-dhilmos"] = {order=data.raw["item-subgroup"]["py-alienlife-dhilmos"].order or "e-x[water]-1"},
        ["recipe-py-alienlife-zipir"] = {order=data.raw["item-subgroup"]["py-alienlife-zipir"].order or "e-x[water]-2"},
        ["recipe-py-alienlife-trits"] = {order=data.raw["item-subgroup"]["py-alienlife-trits"].order or "e-x[water]-3"},
        ["recipe-py-alienlife-xyhiphoe"] = {order=data.raw["item-subgroup"]["py-alienlife-xyhiphoe"].order or "e-x[water]-4"},
        ["recipe-py-alienlife-numal"] = {order=data.raw["item-subgroup"]["py-alienlife-numal"].order or "e-x[water]-5"},
        ["recipe-py-alienlife-fish"] = {order=data.raw["item-subgroup"]["py-alienlife-fish"].order or "e-x[water]-6"},
        ["recipe-py-alienlife-cridren"] = {order=data.raw["item-subgroup"]["py-alienlife-cridren"].order or "f-1"},
        ["recipe-py-alienlife-plants"] = {order=data.raw["item-subgroup"]["py-alienlife-plants"].order or "f-1"},
        ["recipe-py-alienlife-sea-sponge"] = {order=data.raw["item-subgroup"]["py-alienlife-sea-sponge"].order or "f-2"},
        ["recipe-py-alienlife-sponge"] = {order=data.raw["item-subgroup"]["py-alienlife-sponge"].order or "f-2"},
        --["recipe-py-alienlife-biosample"] = {order=data.raw["item-subgroup"]["py-alienlife-biosample"].order or "f-4"},
        ["recipe-py-alienlife-ralesia"] = {order=data.raw["item-subgroup"]["py-alienlife-ralesia"].order or "f-a"},
        ["recipe-py-alienlife-rennea"] = {order=data.raw["item-subgroup"]["py-alienlife-rennea"].order or "f-b"},
        ["recipe-py-alienlife-yotoi"] = {order=data.raw["item-subgroup"]["py-alienlife-yotoi"].order or "f-c"},
        ["recipe-py-alienlife-tuuphra"] = {order=data.raw["item-subgroup"]["py-alienlife-tuuphra"].order or "f-d"},
        ["recipe-py-alienlife-grod"] = {order=data.raw["item-subgroup"]["py-alienlife-grod"].order or "f-e"},
        ["recipe-py-alienlife-kicalk"] = {order=data.raw["item-subgroup"]["py-alienlife-kicalk"].order or "f-g"},
        ["recipe-py-alienlife-cadaveric"] = {order=data.raw["item-subgroup"]["py-alienlife-cadaveric"].order or "f-h"},
        ["recipe-py-alienlife-guar"] = {order=data.raw["item-subgroup"]["py-alienlife-guar"].order or "f-i"},
        ["recipe-py-alienlife-mova"] = {order=data.raw["item-subgroup"]["py-alienlife-mova"].order or "f-j"},
        ["recipe-py-alienlife-bhoddos"] = {order=data.raw["item-subgroup"]["py-alienlife-bhoddos"].order or "g-a"},
        ["recipe-py-alienlife-fawogae"] = {order=data.raw["item-subgroup"]["py-alienlife-fawogae"].order or "g-b"},
        ["recipe-py-alienlife-navens"] = {order=data.raw["item-subgroup"]["py-alienlife-navens"].order or "g-c"},
        ["recipe-py-alienlife-yaedols"] = {order=data.raw["item-subgroup"]["py-alienlife-yaedols"].order or "g-d"},
        ["recipe-py-alienlife-moon"] = {order=data.raw["item-subgroup"]["py-alienlife-moon"].order or "g-ea"},
        ["recipe-py-alienlife-moss"] = {order=data.raw["item-subgroup"]["py-alienlife-moss"].order or "g-eb"},
        ["recipe-py-alienlife-seaweed"] = {order=data.raw["item-subgroup"]["py-alienlife-seaweed"].order or "g-ec"},
        ["recipe-py-alienlife-sap"] = {order=data.raw["item-subgroup"]["py-alienlife-sap"].order or "g-ed"},
        ["recipe-py-alienlife-tree"] = {order=data.raw["item-subgroup"]["py-alienlife-tree"].order or "g-ed"},
    },
    ["combat"] = {
        ["tool"] = {order="1b"},
    ...
    ["environment"] = {
        ...
        --["mineable-materials"] = {order="i2", items={"coal-rock", "iron-rock", "copper-rock", "aluminium-rock", "tin-rock", "zinc-rock", "lead-rock", "titanium-rock", "nickel-rock", "chromium-rock", "quartz-rock", "nexelit-rock", "antimonium", "rare-earth-bolide", "niobium", "salt-rock", "sulfur-patch", "phosphate-rock-02", "uranium-rock", "volcanic-pipe", "regolites"}},
        ["enemies"] = {order="j"},
...
if settings.startup["pysimple-recipe-menu"].value then
    ...
    local to_hide = {
        ["hidden"] = {
            ...
            ["item"] = {"solar-panel", "thorium-232", "th-233", "u-239", "u-240", "plutonium", "additional-part-mk01", "additional-part-mk02", "nexelit-mine", "py-turbine"}, -- inaccessible items
            ["recipe"] = {"solar-panel", "oil-refinery", "pumpjack", "py-turbine", "empty-processed-light-oil-canister", "fertilizer", "fawogae", "fawogae2", "guar-01", "guar-02", "guar-03", "guar-04", "guar-05", "raw-fiber", "raw-fiber2", "raw-fiber3", "raw-fiber4", "bonemeal", "bonemeal-salt", "bonemeal2", "bonemeal3", "bonemeal4", "mukmoux-fat", "mukmoux-fat-salt", "mukmoux-fat2", "mukmoux-fat3", "arthropod-blood", "nuclear-fuel-reprocessing", "nuclear-fuel-reprocessing-mk02", "nuclear-fuel-reprocessing-mk03", "nuclear-fuel-reprocessing-mk04", "nuclear-fuel-reprocessing-mk05", "kovarex-enrichment-process", "pa-uranium-235"}, -- these recipes are unavailable - they are neither TURDs nor unlockable via any techs
        },
    ...
    -- TODO: Can resources be moved in factoriopedia or are they always stuck with their item versions if they share the same internal name? It would be nice to have them all visible from the environment tab
    --[[
    local resources = {
        {"ore-bioreserve", "00a"},
        {"stone", "00b"},
