...
local groups = {
    ["logistics"] = {
        ...
        ["energy-pipe-distribution"] = {items={"nexelit-power-pole", "nexelit-substation", "pipe", "pipe-to-ground", "pump"}, recipes={"pipe", "casting-pipe", "hotair-casting-pipe", "pipe-to-ground", "casting-pipe-ug", "hotair-casting-pipe-ug", "pump"}},
    ...
    ["production"] = {
        ...
        ["module"] = {order="zpy[general]-x"},
        ["science-pack"] = {order="zpy[general]-y", items={{"lab","0"}, "space-science-pack"}},
        ["space-related"] = {order="zpy[general]-z", items={"rocket-part", "capsule", "microwave-satellite", "satellite", "destablilized-toxirus"}},
        ["py-alternativeenergy-buildings-mk01"] = {order="zpy[mk01]-a[power]", items={{"steam-turbine-mk01","1"}, {"py-heat-exchanger","2"}, "solar-panel-mk01", "tidal-mk01", "vawt-turbine-mk01", "hawt-turbine-mk01", "multiblade-turbine-mk01"}},
        ["py-alternativeenergy-buildings-mk02"] = {order="zpy[mk02]-a[power]", items={{"steam-turbine-mk02","1"}, {"py-heat-exchanger-mk02","2"}, "solar-panel-mk02", "tidal-mk02", "vawt-turbine-mk02", "hawt-turbine-mk02"}},
        ["py-alternativeenergy-buildings-mk03"] = {order="zpy[mk03]-a[power]", items={{"steam-turbine-mk03","1"}, {"py-heat-exchanger-mk03","2"}, "solar-panel-mk03", "tidal-mk03", "vawt-turbine-mk03", "hawt-turbine-mk03", "multiblade-turbine-mk03"}},
        ...
        ["py-mining-mk01"] = {order="zpy[mk01]-b[extraction]", items={"collector", "soil-extractormk01", "clay-pit-mk01", "fluid-drill-mk01", "borax-mine", "antimonium-drill-mk01", "ree-mining-drill-mk01", "natural-gas-seep-mk01", "bitumen-seep-mk01", "oil-sand-extractor-mk01", "tar-seep-mk01", "coalbed-mk01", "pumpjack-mk01", "sand-extractor", "ground-borer", "spore-collector-mk01", "tholin-atm-mk01"}},
        ["py-mining-mk02"] = {order="zpy[mk02]-b[extraction]", items={"collector-mk02", "soil-extractormk02", "clay-pit-mk02", "fluid-drill-mk02", "borax-mine-mk02", "antimonium-drill-mk02", "ree-mining-drill-mk02", "natural-gas-seep-mk02", "bitumen-seep-mk02", "oil-sand-extractor-mk02", "tar-seep-mk02", "coalbed-mk02", "pumpjack-mk02", "sand-extractor-mk02", "ground-borer-mk02", "spore-collector-mk02", "tholin-atm-mk02"}},
        ["py-mining-mk03"] = {order="zpy[mk03]-b[extraction]", items={"collector-mk03", "soil-extractormk03", "clay-pit-mk03", "fluid-drill-mk03", "borax-mine-mk03", "antimonium-drill-mk03", "ree-mining-drill-mk03", "natural-gas-seep-mk03", "bitumen-seep-mk03", "oil-sand-extractor-mk03", "tar-seep-mk03", "coalbed-mk03", "pumpjack-mk03", "sand-extractor-mk03", "ground-borer-mk03", "spore-collector-mk03", "tholin-atm-mk03"}},
        ["py-mining-mk04"] = {order="zpy[mk04]-b[extraction]", items={"collector-mk04", "soil-extractormk04", "clay-pit-mk04", "fluid-drill-mk04", "borax-mine-mk04", "antimonium-drill-mk04", "ree-mining-drill-mk04", "natural-gas-seep-mk04", "bitumen-seep-mk04", "oil-sand-extractor-mk04", "tar-seep-mk04", "coalbed-mk04", "pumpjack-mk04", "sand-extractor-mk04", "ground-borer-mk04", "spore-collector-mk04", "tholin-atm-mk04"}},
    ...
    ["py-hightech"] = { -- renamed "intermediate products"
        ...
        ["py-alternativeenergy-parts-4"] = {order="zpy-08", items={"brake-mk04", "shaft-mk04", "gearbox-mk04", "utility-box-mk04", "controler-mk04", "electronics-mk04", "mechanical-parts-04", "fes", "hydraulic-system-mk02", "tower-mk04", "anemometer-mk04", "blade-mk04", "rotor-mk04", "yaw-drive-mk04", "heating-system", "inside-turbine", "nacelle-mk04"}, recipes={{"hotair-shaft-mk04"}}},
        ...
        ["py-intermediates-5"] = {order="zpy-11", items={"carbon-black", "rubber", "graphite", "sb-oxide", "pyrite", "iron-oxide"}},
        ...
        ["py-hightech-aerogel"] = {order="zpy-35", items={"rf-gel", "clean-rf-gel", "soaked-gel", "aerogel", "carbon-aerogel", "sub-denier-microfiber", "low-density-structure", "rocket-control-unit"}},
        ...
        ["py-intermediates-40"] = {order="zpy-56", items={"empty-barrel", "empty-fuel-canister", "empty-gas-canister", "methanol-gas-canister", "empty-proto-tholins-vessel", "filled-proto-tholins-vessel", "empty-tholins-vessel", "filled-tholins-vessel"}, recipes={"empty-methanol-gas-canister", "barrel-milk", "fill-milk-barrel", "empty-milk-barrel", "empty-proto-tholins-vessel", "fill-proto-tholins-vessel", "empty-tholins-vessel"}},
    ...
    ["py-rawores"] = { -- renamed "materials"
        ...
        ["py-rawores-aluminium"] = {order="zpy-13", items={"aluminium-plate", "ore-aluminium", "grade-1-aluminium", "grade-2-aluminium", "grade-3-aluminium", "grade-4-aluminium", "powdered-aluminium", "al-pulp-01", "al-pulp-02", "al-pulp-03", "al-pulp-04", "sodium-aluminate", "crystalized-sodium-aluminate", "high-grade-alumina", "reduced-aluminium", "sintered-aluminium", "molten-aluminium", "al-biomass", "al-tailings"}, recipes={{"mining-aluminium"}}},
        ...
        ["py-rawores-nickel"] = {order="zpy-18", items={"nickel-plate", "ore-nickel", "grade-1-nickel", "grade-2-nickel", "grade-3-nickel", "grade-4-nickel", "nickel-rejects", "prepared-nickel-pulp", "nickel-overflow", "nickel-pulp-01", "nickel-pulp-02", "nickel-slime", "nickel-tailings", "nickel-pulp-03", "nickel-pulp-04", "nickel-prepared-solution", "high-grade-nickel", "reduced-nickel", "sintered-nickel", "molten-nickel", "ni-biomass"}, recipes={{"nickel-plate-2"}, {"nickel-plate-3"}, {"hotair-nickel-plate-3"}, {"pa-nickel"}, {"mining-nickel"}}},
        ...
        ["py-rawores-phosphate"] = {order="zpy-29", items={"phosphate-rock", "powdered-phosphate-rock", "tbp-2", "p2s5", "phosphate-glass"}},
        ...
        ["py-rawores-regolite"] = {order="zpy-38", items={"regolite-rock", "crushed-regolite", "powdered-regolite", "regolite-dust", "calcinates", "calcinate-separation"}},
    ...
    ["py-petroleum-handling"] = { -- renamed "fluids"
        ...
        ["py-fluids-23"] = {order="zpy-23", items={"chlorine", "hydrogen-chloride", "dcm", "trichlorosilane", "pure-trichlorosilane", "chloral", "phosphorous-tricloride", "phosphoryl-chloride", "phosphorus-tricloride", "chloromethane", "dimethyldichlorosilane", "ech", "chloroauric-acid"}, recipes={{"chlorine","zp-item-01b"}}},
        ...
        ["py-fluids-34"] = {order="zpy-34", items={"ethanolamine", "gta", "pre-pesticide-01", "pre-pesticide-02", "fish-hydrolysate", "fish-emulsion", "fish-oil", "fetal-serum", "liquid-manure", "depolymerized-organics", "creamy-latex", "formic-acid", "zogna-bacteria", "manure-bacteria", "bacteria-1", "bacteria-2", "artificial-blood"}},
        ...
        ["py-fluids"] = {order="zpy-xd"},
        ["py-quenching-ores"] = {order="zpy-xe"},
        ["py-syngas"] = {order="zpy-xf"},
        ["py-methanol"] = {order="zpy-xg"},
        ["py-fusion-fluids"] = {order="zpy-xh"},
        ["py-fusion-gases"] = {order="zpy-xi"},
        ["py-alternativeenergy-fluids"] = {order="zpy-xj"},
        ["py-hightech-fluids"] = {order="zpy-xk"},
        ["py-petroleum-handling-fluids"] = {order="zpy-xl"},
        ["py-petroleum-handling-oil-sand-recipes"] = {order="zpy-xm"},
        ["py-petroleum-handling-scrude-recipes"] = {order="zpy-xn"},
        ["py-petroleum-handling-lubricant-recipes"] = {order="zpy-xo"},
        ["py-petroleum-handling-recipes"] = {order="zpy-xp"},
        ["py-petroleum-handling-tholin-recipes"] = {order="zpy-xq"},
        ["py-petroleum-handling-hot-air"] = {order="zpy-xr"},
        ["py-rawores-fluids"] = {order="zpy-xs"},
        ["py-alienlife-fluids"] = {order="zpy-xt"},
        ["py-alienlife-gases"] = {order="zpy-xu"},
        ["py-nuclear-waste"] = {order="zpy-xv"},
        ["py-combustion"] = {order="zpy-xw"},
    },
    ["py-alienlife"] = { -- renamed "life"
        ["py-alienlife-buildings-mk01"] = {items={"creature-chamber", "bio-printer-mk01", "rc-mk01", "incubator-mk01", "botanical-nursery", "plankton-farm", "bio-reactor-mk01", "biofactory-mk01", "slaughterhouse-mk01", "atomizer-mk01", "compost-plant-mk01", "micro-mine-mk01", "genlab-mk01", "research-center-mk01"}},
        ...
        ["py-alienlife-special-creatures"] = {items={"crawdad", "dingrido", "spidertron", "phadaisus", "workers-food", "workers-food-02", "workers-food-03", "gastrocapacitor"}},
        ...
        ["py-alienlife-items"] = {items={{"cage","a"}, "energy-drink", "dried-meat", "bedding", "sporopollenin", "cellulose", "lignin", "biomass", "powdered-biomass", "fine-powdered-biomass", "dried-biomass", "fungal-substrate", "fungal-substrate-02", "fungal-substrate-03", "urea", "guano", "ammonium-nitrate", "manure", "fertilizer", "guar-gum", "stone-wool", "raw-fiber", "fiber", "powdered-ralesia-seeds", "seeds-extract-01", "starch", "blood-meal", "albumin", "sugar", "sodium-alginate", "latex-slab", "latex", "resilin", "casein", "pesticide-mk01", "pesticide-mk02"}},
        ...
        ["py-alienlife-genetics"] = {items={"retrovirus", "resveratrol", "enzyme-pks", "bioreceptor", "cysteine", "serine", "purine-analogues", "zinc-finger-proteins", "moss-gen", "plasmids", "cdna", "enediyne", "ammonium-sulfate", "guaiacol", "sample-cup", "pacifastin", "cytostatics", "microcin-j25", "chimeric-proteins", "zymogens", "primers", "dna-polymerase", "adam42-gen", "mmp", "peptidase-m58", "pheromones", "propeptides", "mpa", "immunosupressants", "nanochondria", "nanozymes", "myoglobin", "recombinant-ery", "anabolic-rna", "antitumor", "antiviral", "bmp", "cbp", "dynemicin", "gh", "orexigenic", "reca"}},
        ["py-alienlife-science"] = {order="bd-2", items={"agar", "empty-petri-dish", "petri-dish", "petri-dish-bacteria", "fawogae-substrate", "ground-sample01", "bio-sample01", "bio-container", "bio-sample", "alien-sample01", "alien-sample-02", "alien-sample-03", "perfect-samples", "alien-enzymes", "animal-sample-01", "solidified-sarcorus", "paragen", "negasium", "nonconductive-phazogen", "denatured-seismite", "hyaline", "nano-cellulose", "magnetic-beads", "hmas", "empty-neuromorphic-chip", "neuromorphic-chip", "neuroprocessor"}},
        ...
        ["py-alienlife-codex-mk04"] = {items={"xeno-codex-mk04", "zipir-codex-mk04", "zungror-codex-mk04", "vonix-codex-mk04"}},
        ...
        ["py-alienlife-vrauks"] = {items={"blood-caged-vrauks", "brain-caged-vrauks", "guts-caged-vrauks", "meat-caged-vrauks", "chitin-caged-vrauks", "caged-vrauks", "cocoon", "cocoon-mk02", "cocoon-mk03", "cocoon-mk04", "vrauks", "vrauks-mk02", "vrauks-mk03", "vrauks-mk04"}, recipes={{"full-render-vrauks","1"}, {"ex-blo-vrauks"}, {"ex-bra-vrauks","a03"}, {"ex-gut-vrauks"}, {"ex-me-vrauks"}, {"ex-ski-vrauks"}, {"extract-vrauks-eye"}}},
        ...
        ["py-alienlife-xeno"] = {items={"sulfuric-xeno", "bone-xeno", "brain-xeno", "meat-xeno", "chitin-xeno", {"cognition-osteochain","b"}, "caged-xeno", "xeno-egg", "xeno", "xeno-mk02", "xeno-mk03", "xeno-mk04"}, recipes={{"full-render-xenos","1"}, {"ex-blo-xeno",}, {"ex-bon-xeno"}, {"ex-bra-xeno"}, {"ex-me-xeno"}, {"ex-chi-xeno"}}},
        ...
        ["py-alienlife-sea-sponge"] = {order="f-2", items={"sea-sponge-sprouts", "sea-sponge-sprouts-mk02", "sea-sponge-sprouts-mk03", "sea-sponge-sprouts-mk04", "sea-sprouts", "sea-sponge-mk02", "sea-sponge-mk03", "sea-sponge-mk04"}},
        ["py-alienlife-sponge"] = {order="f-3"},
        ["py-alienlife-biosample"] = {order="f-4", items={"native-flora"}},
        ["py-alienlife-ralesia"] = {items={"ralesias", "ralesias-mk02", "ralesias-mk03", "ralesias-mk04", "ralesia-seeds", "ralesia-seeds-mk02", "ralesia-seeds-mk03", "ralesia-seeds-mk04", "dry-ralesia", "ralesia-powder"}},
        ...
        ["py-alienlife-kicalk"] = {items={"kicalk", "kicalk-mk02", "kicalk-mk03", "kicalk-mk04", "kicalk-seeds", "kicalk-seeds-mk02", "kicalk-seeds-mk03", "kicalk-seeds-mk04", "dried-kicalk"}},
        ["py-alienlife-cadaveric"] = {items={"cadaveric-arum", "cadaveric-arum-mk02-a", "cadaveric-arum-mk03-a", "cadaveric-arum-mk04-a", "cadaveric-arum-seeds", "cadaveric-arum-mk02-seeds", "cadaveric-arum-mk03-seeds", "cadaveric-arum-mk04-seeds", "cadaveric-arum-mk02-seed-juice", "cadaveric-arum-mk03-seed-juice", "cadaveric-arum-mk04-seed-juice", "residual-gas"}},
    ...
    if recipe then
        ...
        if recipe.main_product then
            ...
            for _,diff in pairs(diffs) do
                if recipe[diff] and recipe[diff].results and #recipe.results > 0 then
...
if settings.startup["pysimple-recipe-menu"].value then
    ...
    for name,tab in pairs(tabs) do
        data.raw["item-group"][name].localised_name = {"name."..name}
