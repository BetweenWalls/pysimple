...
local groups = {
    ...
    ["production"] = {
        ...
        ["science-pack"] = {order="zpy[general]-y", items={{"lab","0"}}, recipes={"space-science-pack", "macguffin", "space-science-pack-real"}}, -- hardmode only: macguffin, space-science-pack-real
    ...
    ["py-petroleum-handling"] = { -- renamed "fluids"
        ...
        ["py-fluids-4"] = {order="zpy-04", items={"water", "water-saline", "pressured-water", "subcritical-water", "geothermal-water", "waste-water", "dirty-water-light"}},
        ...
        ["py-fluids-12"] = {order="zpy-12", items={"pitch", "middle-oil", "anthracene-oil", "naphthalene-oil", "carbolic-oil", "creosote", "dirty-water-heavy"}, recipes={{"tar-refining","zpy-item-00b"}, {"pitch-refining","zpy-item-00c"}, {"tar-refining-tops","zpy-item-02b"}, "tar-quenching"}},
    ...
    ["py-alienlife"] = { -- renamed "life"
        ...
        ["py-alienlife-replicators"] = {order="dx", items={"replicator-bioreserve", "replicator-ralesia", "replicator-kicalk", "replicator-tuuphra", "replicator-rennea", "replicator-yotoi", "replicator-yotoi-fruit", "replicator-grod", "replicator-cadaveric-arum", "replicator-mova"}},
        ...
        ["py-alienlife-auog"] = {order="e-b", items={"blood-caged-auog", "bone-caged-auog", "brain-caged-auog", "fat-caged-auog", "guts-caged-auog", "meat-caged-auog", "skin-caged-auog", {"glandular-myocluster","b2"}, "caged-auog", "auog-pup", "auog-pup-mk02", "auog-pup-mk03", "auog-pup-mk04", "charged-auog", "auog", "auog-mk02", "auog-mk03", "auog-mk04", "used-auog", "used-auog-mk02", "used-auog-mk03", "used-auog-mk04"}, recipes={{"full-render-auogs",""}, {"ex-used-auog","2"}, {"ex-used-auog-lard","2b"}, {"ex-used-auog-laser","2c"}, {"ex-used-auog-music","2d"}, {"ex-blo-auog"}, {"ex-bon-auog"}, {"ex-bra-auog","a05"}, {"ex-fat-auog"}, {"ex-gut-auog"}, {"ex-me-auog"}, {"ex-ski-auog"}, {"extract-auog-eye"}, "auog-pooping-1", "auog-pooping-2", "auog-pooping-3", "auog-pooping-4", "auog-pooping-5"}},
        ["py-alienlife-cottongut"] = {order="e-c", items={"blood-cottongut", "bone-cottongut", "brain-cottongut", "fat-cottongut", "guts-cottongut", "meat-cottongut", "skin-cottongut", {"lcc","b"}, "cottongut-pup", "cottongut-pup-mk01", "cottongut-pup-mk02", "cottongut-pup-mk03", "cottongut-pup-mk04", "cottongut-mk01", "cottongut-mk02", "cottongut-mk03", "cottongut-mk04", "cottongut"}, recipes={{"full-render-cottongut",""}, {"ex-blo-cot"}, {"ex-bon-cot"}, {"ex-bra-cot"}, {"ex-fat-cot"}, {"ex-gut-cot"}, {"ex-me-cot"}, {"ex-ski-cot"}}},
        ["py-alienlife-ulric"] = {order="e-d", items={"blood-caged-ulric", "bone-caged-ulric", "brain-caged-ulric", "fat-caged-ulric", "guts-caged-ulric", "meat-caged-ulric", "skin-caged-ulric", {"magnetic-organ","b2"}, "caged-ulric", "ulric-cub", "ulric-cub-mk02", "ulric-cub-mk03", "ulric-cub-mk04", "ulric", "ulric-mk02", "ulric-mk03", "ulric-mk04", "used-ulric", "used-ulric-mk02", "used-ulric-mk03", "used-ulric-mk04", "ulric-mk02-dna-sample", "ulric-mk03-dna-sample", "ulric-mk04-dna-sample", "sample-cup", "saddle"}, recipes={{"full-render-ulrics",""}, {"ex-blo-ulr"}, {"ex-bon-ulr"}, {"ex-bra-ulr"}, {"ex-fat-ulr"}, {"ex-gut-ulr"}, {"ex-me-ulr"}, {"ex-ski-ulr"}, {"extract-ulric-eye"}, "ulric-manure-1", "ulric-manure-2", "ulric-manure-3", "ulric-manure-4"}},
        ["py-alienlife-arqad"] = {order="e-e", items={"blood-arqad", "guts-arqad", "meat-arqad", "chitin-arqad", {"sternite-lung","b"}, "arqad-egg-nest", "arqad-egg-nest-2", "arqad-egg-nest-3", "arqad-egg-nest-4", "arqad-egg", "arqad-egg-2", "arqad-egg-3", "arqad-egg-4", "arqad-maggot", "arqad-maggot-2", "arqad-maggot-3", "arqad-maggot-4", "arqad-queen", "arqad", "arqad-mk02", "arqad-mk03", "arqad-mk04", "empty-comb", "filled-comb", "wax", "wax-barrel", "empty-honeycomb", "honeycomb", "arqad-honey", "bee-venom", "arqad-propolis", "arqad-jelly-barrel", "arqad-jelly", "cags"}, recipes={{"full-render-arqads",""}, {"ex-blo-arq"}, {"ex-gut-arq"}, {"ex-me-arq"}, {"ex-chi-arq"}}},
        ["py-alienlife-korlex"] = {order="e-f", items={"blood-caged-korlex", "bone-caged-korlex", "brain-caged-korlex", "fat-caged-korlex", "guts-caged-korlex", "meat-caged-korlex", "skin-caged-korlex", {"cryogland","b"}, "caged-korlex", "korlex-pup", "korlex", "korlex-mk02", "korlex-mk03", "korlex-mk04", "milk", "empty-barrel-milk", "barrel-milk", "casein-mixture", "casein-pulp-01", "casein-pulp-02", "casein-solution"}, recipes={{"full-render-kor",""}, {"ex-blo-kor"}, {"ex-bon-kor"}, {"ex-bra-kor"}, {"ex-fat-kor"}, {"ex-gut-kor"}, {"ex-me-kor"}, {"ex-ski-kor"}}},
        ["py-alienlife-mukmoux"] = {order="e-g", items={"blood-caged-mukmoux", "bone-caged-mukmoux", "brain-caged-mukmoux", "fat-caged-mukmoux", "guts-caged-mukmoux", "meat-caged-mukmoux", "skin-caged-mukmoux", "caged-mukmoux", "mukmoux-calf", "mukmoux", "mukmoux-mk02", "mukmoux-mk03", "mukmoux-mk04"}, recipes={{"full-render-mukmoux",""}, {"ex-blo-muk"}, {"ex-bon-muk"}, {"ex-bra-muk"}, {"ex-fat-muk"}, {"ex-gut-muk"}, {"ex-me-muk"}, {"ex-ski-muk"}, {"extract-mukmoux-eye"}, "mukmoux-manure-1", "mukmoux-manure-2", "mukmoux-manure-3", "mukmoux-manure-4", "mukmoux-manure-1-mukmoux-turd", "mukmoux-manure-2-mukmoux-turd", "mukmoux-manure-3-mukmoux-turd", "mukmoux-manure-4-mukmoux-turd"}},
        ["py-alienlife-phagnot"] = {order="e-h", items={"blood-caged-phagnot", "bone-caged-phagnot", "brain-caged-phagnot", "guts-caged-phagnot", "meat-caged-phagnot", {"geostabilization-tissue","b"}, "skin-caged-phagnot", "caged-phagnot", "phagnot-cub", "phagnot-cub-mk02", "phagnot-cub-mk03", "phagnot-cub-mk04", "phagnot", "phagnot-mk02", "phagnot-mk03", "phagnot-mk04", "gas-bladder"}, recipes={{"full-render-phagnots",""}, {"ex-blo-phag"}, {"ex-bon-phag"}, {"ex-bra-phag"}, {"ex-gut-phag"}, {"ex-me-phag"}, {"ex-ski-phag"}}},
        ["py-alienlife-arthurian"] = {order="e-i", items={"blood-caged-arthurian", "bone-caged-arthurian", "brain-caged-arthurian", "fat-caged-arthurian", "guts-caged-arthurian", "meat-caged-arthurian", "skin-caged-arthurian", {"polynuclear-ganglion","b"}, "caged-arthurian", "arthurian-egg", "arthurian-egg-mk02", "arthurian-egg-mk03", "arthurian-egg-mk04", "arthurian-pup", "arthurian-pup-mk02", "arthurian-pup-mk03", "arthurian-pup-mk04", "arthurian", "arthurian-mk02", "arthurian-mk03", "arthurian-mk04", "abacus"}, recipes={{"full-render-arthurian",""}, {"ex-blo-art"}, {"ex-bon-art"}, {"ex-bra-art"}, {"ex-fat-art"}, {"ex-gut-art"}, {"ex-me-art"}, {"ex-ski-art"}}},
        ["py-alienlife-scrondrix"] = {order="e-j", items={"blood-caged-scrondrix", "bone-caged-scrondrix", "brain-caged-scrondrix", "fat-caged-scrondrix", "guts-caged-scrondrix", "meat-caged-scrondrix", "skin-caged-scrondrix", {"intestinal-ee","b2"}, "caged-scrondrix", "scrondrix-pup", "scrondrix", "scrondrix-mk02", "scrondrix-mk03", "scrondrix-mk04", {"pineal-gland","zpye"}}, recipes={{"full-render-scrondrixs",""}, {"ex-blo-scro"}, {"ex-bon-scro"}, {"ex-bra-scro","a04"}, {"scrondrix-brain-slaughterhouse-ex", "a04"}, {"ex-fat-scro"}, {"ex-gut-scro"}, {"ex-me-scro"}, {"ex-ski-scro"}, {"extract-scrondrix-eye"}, "Scrondrix-Manure-1", "Scrondrix-Manure-2", "Scrondrix-Manure-3", "Scrondrix-Manure-4"}},
        ["py-alienlife-dingrits"] = {order="e-k", items={"blood-caged-dingrits", "bone-caged-dingrits", "brain-caged-dingrits", "guts-caged-dingrits", "meat-caged-dingrits", "skin-caged-dingrits", "caged-dingrits", "dingrits-cub", "charged-dingrit", "dingrits", "dingrits-mk02", "dingrits-mk03", "dingrits-mk04", "used-dingrit", "used-dingrit-mk02", "used-dingrit-mk03", "used-dingrit-mk04", "fur", "pelt", "dingrit-spike", "space-suit", "space-dingrit", "space-dingrit-return", "snarer-heart", "dingrits-alpha"}, recipes={{"full-render-dingrits",""}, {"ex-used-dingrits","2"}, {"ex-used-dingrits-lard","2b"}, {"ex-used-dingrits-laser","2c"}, {"ex-used-dingrits-music","2d"}, {"ex-blo-din"}, {"ex-bon-din"}, {"ex-bra-din"}, {"ex-gut-din"}, {"ex-me-din"}, {"ex-pelt-din","b1"}}},
        ["py-alienlife-kmauts"] = {order="e-l", items={"blood-caged-kmauts", "brain-caged-kmauts", "fat-caged-kmauts", "guts-caged-kmauts", "meat-caged-kmauts", "caged-kmauts", "kmauts-cub", "kmauts", "kmauts-mk02", "kmauts-mk03", "kmauts-mk04", "tendon"}, recipes={{"full-render-kmauts",""}, {"ex-blo-kma"}, {"ex-bra-kma"}, {"ex-fat-kma"}, {"ex-gut-kma"}, {"ex-me-kma"}}},
        ["py-alienlife-phadai"] = {order="e-m", items={"blood-caged-phadai", "bone-caged-phadai", "brain-caged-phadai", "fat-caged-phadai", "guts-caged-phadai", "meat-caged-phadai", "skin-caged-phadai", {"subdermal-chemosnare","b"}, "caged-phadai", "phadai-pup", "phadai", "phadai-mk02", "phadai-mk03", "phadai-mk04", "used-phadai", "carapace"}, recipes={{"full-render-phadais",""}, {"ex-blo-pha"}, {"ex-bon-pha"}, {"ex-bra-pha"}, {"ex-fat-pha"}, {"ex-gut-pha"}, {"ex-me-pha"}, {"ex-ski-pha"}}},
        ["py-alienlife-simik"] = {order="e-n", items={"blood-caged-simik", "bone-caged-simik", "brain-caged-simik", "fat-caged-simik", "guts-caged-simik", "meat-caged-simik", "skin-caged-simik", {"hormonal","b1"}, {"keratin","b2"}, {"simik-scales","b3"}, "caged-simik", "simik-pup", "simik", "simik-mk02", "simik-mk03", "simik-mk04", "used-simik", "used-simik-mk02", "used-simik-mk03", "used-simik-mk04", "simik-poop"}, recipes={{"full-render-simik",""}, {"ex-blo-sim"}, {"ex-bon-sim"}, {"ex-bra-sim"}, {"ex-fat-sim"}, {"ex-gut-sim"}, {"ex-me-sim"}, {"ex-ski-sim"}}},
        ["py-alienlife-vonix"] = {order="e-o", items={"blood-vonix", "brain-vonix", "fat-vonix", "guts-vonix", "meat-vonix", "skin-vonix", "vonix-eggs", "vonix-cub", "vonix", "vonix-mk02", "vonix-mk03", "vonix-mk04", "venom-gland"}, recipes={{"full-render-vonix",""}, {"ex-blo-von"}, {"ex-bra-von"}, {"ex-fat-von"}, {"ex-gut-von","af"}, {"ex-me-von"}, {"ex-ski-von"}}},
        ["py-alienlife-zungror"] = {order="e-p", items={"blood-caged-zungror", "bone-caged-zungror", "brain-caged-zungror", "fat-caged-zungror", "guts-caged-zungror", "meat-caged-zungror", "skin-caged-zungror", {"vsk","b"}, "caged-zungror", "zungror-cocoon", "zungror", "zungror-mk02", "zungror-mk03", "zungror-mk04", {"pre-fiber-1","zpya"}, {"pre-fiber-2","zpyb"}, {"pre-fiber-3","zpyc"}}, recipes={{"full-render-zun",""}, {"ex-blo-zun"}, {"ex-bra-zun","a04"}, {"ex-fat-zun"}, {"ex-gut-zun"}, {"ex-me-zun"}, {"ex-ski-zun"}}},
        ["py-alienlife-xeno"] = {order="e-q", items={"sulfuric-caged-xeno", "bone-caged-xeno", "brain-caged-xeno", "meat-caged-xeno", "chitin-caged-xeno", {"cognition-osteochain","b"}, "caged-xeno", "xeno-egg", "xeno", "xeno-mk02", "xeno-mk03", "xeno-mk04"}, recipes={{"full-render-xenos",""}, {"ex-blo-xeno",}, {"ex-bon-xeno"}, {"ex-bra-xeno"}, {"ex-me-xeno"}, {"ex-chi-xeno"}}},
        ...
        ["py-alienlife-zipir"] = {order="e-x[water]-1", items={"blood-zipir", "brain-zipir", "fat-zipir", "guts-zipir", "meat-zipir", "skin-zipir", {"adaptable-automucosa","b"}, "zipir-eggs", "zipir-pup", "zipir1", "zipir2", "zipir3", "zipir4", "zipir-carcass"}, recipes={{"full-render-zipir",""}, {"rendering","1"}, {"ex-blo-zipir"}, {"ex-bra-zipir"}, {"ex-fat-zipir"}, {"ex-gut-zipir"}, {"ex-me-zipir"}, {"ex-ski-zipir"}}},
        ["py-alienlife-trits"] = {order="e-x[water]-2", items={"blood-trits", "bone-trits", "brain-trits", "fat-trits", "guts-trits", "meat-trits", "skin-trits", {"photophore","b"}, "trits-pup", "trits", "trits-mk02", "trits-mk03", "trits-mk04"}, recipes={{"full-render-trit",""}, {"ex-blo-trit"}, {"ex-bon-trit"}, {"ex-bra-trit"}, {"ex-fat-trit"}, {"ex-gut-trit"}, {"ex-me-trit"}, {"ex-ski-trit"}}},
        ["py-alienlife-xyhiphoe"] = {order="e-x[water]-3", items={"blood-xyhiphoe", "guts-xyhiphoe", "meat-xyhiphoe", "shell-xyhiphoe", "xyhiphoe-cub", "xyhiphoe-cub-mk02", "xyhiphoe-cub-mk03", "xyhiphoe-cub-mk04", "xyhiphoe", "xyhiphoe-mk02", "xyhiphoe-mk03", "xyhiphoe-mk04", "shell"}, recipes={{"full-render-xyhiphoe",""}, {"ex-blo-xyh"}, {"ex-gut-xyh"}, {"ex-me-xyh"}, {"ex-ski-xyh","b"}}},
        ["py-alienlife-dhilmos"] = {order="e-x[water]-4", items={"blood-dhilmos", "fat-dhilmos", "guts-dhilmos", "meat-dhilmos", {"autoantigens","b"}, "dhilmos-egg", "dhilmos-pup", "dhilmos", "dhilmos-mk02", "dhilmos-mk03", "dhilmos-mk04"}, recipes={{"full-render-dhilmoss",""}, {"ex-blo-dhi"}, {"ex-fat-dhi"}, {"ex-gut-dhi"}, {"ex-me-dhi"}, {"extract-dhilmos-eye"}}},
        ["py-alienlife-numal"] = {order="e-x[water]-5", items={"blood-numal", "guts-numal", "meat-numal", "skin-numal", "chitin-numal", {"aeroorgan","b"}, "numal-egg", "numal", "numal-mk02", "numal-mk03", "numal-mk04", "numal-ink"}, recipes={{"full-render-num",""}, {"ex-blo-num"}, {"ex-gut-num"}, {"ex-gut-num-neodymium"}, {"ex-me-num"}, {"ex-ski-num"}}},
        ["py-alienlife-fish"] = {order="e-x[water]-6", items={"fish-egg", "fish-egg-mk02", "fish-egg-mk03", "fish-egg-mk04", "fish", "fish-mk02", "fish-mk03", "fish-mk04", "fish-oil", "fish-hydrolysate", "fishmeal", "fish-emulsion"}, recipes={{"full-render-fish",""}}},
        ...
        ["recipe-py-alienlife-vrauks"] = {order=data.raw["item-subgroup"]["py-alienlife-vrauks"].order or "e-a"},
        ["recipe-py-alienlife-auog"] = {order=data.raw["item-subgroup"]["py-alienlife-auog"].order or "e-b"},
        ["recipe-py-alienlife-cottongut"] = {order=data.raw["item-subgroup"]["py-alienlife-cottongut"].order or "e-c"},
        ["recipe-py-alienlife-ulric"] = {order=data.raw["item-subgroup"]["py-alienlife-ulric"].order or "e-d"},
        ["recipe-py-alienlife-arqad"] = {order=data.raw["item-subgroup"]["py-alienlife-arqad"].order or "e-e"},
        ["recipe-py-alienlife-korlex"] = {order=data.raw["item-subgroup"]["py-alienlife-korlex"].order or "e-f"},
        ["recipe-py-alienlife-mukmoux"] = {order=data.raw["item-subgroup"]["py-alienlife-mukmoux"].order or "e-g"},
        ["recipe-py-alienlife-phagnot"] = {order=data.raw["item-subgroup"]["py-alienlife-phagnot"].order or "e-h"},
        ["recipe-py-alienlife-arthurian"] = {order=data.raw["item-subgroup"]["py-alienlife-arthurian"].order or "e-i"},
        ["recipe-py-alienlife-scrondrix"] = {order=data.raw["item-subgroup"]["py-alienlife-scrondrix"].order or "e-j"},
        ["recipe-py-alienlife-kmauts"] = {order=data.raw["item-subgroup"]["py-alienlife-kmauts"].order or "e-k"},
        ["recipe-py-alienlife-dingrits"] = {order=data.raw["item-subgroup"]["py-alienlife-dingrits"].order or "e-l"},
        ["recipe-py-alienlife-phadai"] = {order=data.raw["item-subgroup"]["py-alienlife-phadai"].order or "e-m"},
        ["recipe-py-alienlife-simik"] = {order=data.raw["item-subgroup"]["py-alienlife-simik"].order or "e-n"},
        ["recipe-py-alienlife-vonix"] = {order=data.raw["item-subgroup"]["py-alienlife-vonix"].order or "e-o"},
        ["recipe-py-alienlife-zungror"] = {order=data.raw["item-subgroup"]["py-alienlife-zungror"].order or "e-p"},
        ["recipe-py-alienlife-xeno"] = {order=data.raw["item-subgroup"]["py-alienlife-xeno"].order or "e-q"},
        ["recipe-py-alienlife-antelope"] = {order=data.raw["item-subgroup"]["py-alienlife-antelope"].order or "e-r"},
        ["recipe-py-alienlife-zipir"] = {order=data.raw["item-subgroup"]["py-alienlife-zipir"].order or "e-x[water]-1"},
        ["recipe-py-alienlife-trits"] = {order=data.raw["item-subgroup"]["py-alienlife-trits"].order or "e-x[water]-2"},
        ["recipe-py-alienlife-xyhiphoe"] = {order=data.raw["item-subgroup"]["py-alienlife-xyhiphoe"].order or "e-x[water]-3"},
        ["recipe-py-alienlife-dhilmos"] = {order=data.raw["item-subgroup"]["py-alienlife-dhilmos"].order or "e-x[water]-4"},
        ...
        ["recipe-py-alienlife-plants"] = {order=data.raw["item-subgroup"]["py-alienlife-plants"].order or "f"},
        ...
        ["recipe-py-alienlife-sponge"] = {order=data.raw["item-subgroup"]["py-alienlife-sponge"].order or "f-3"},
        --["recipe-py-alienlife-biosample"] = {order=data.raw["item-subgroup"]["py-alienlife-biosample"].order or "f-a"},
        ["recipe-py-alienlife-moss"] = {order=data.raw["item-subgroup"]["py-alienlife-moss"].order or "f-b"},
        ["recipe-py-alienlife-seaweed"] = {order=data.raw["item-subgroup"]["py-alienlife-seaweed"].order or "f-c"},
        ["recipe-py-alienlife-tree"] = {order=data.raw["item-subgroup"]["py-alienlife-tree"].order or "f-d"},
        ["recipe-py-alienlife-sap"] = {order=data.raw["item-subgroup"]["py-alienlife-sap"].order or "f-e"},
        ["recipe-py-alienlife-moon"] = {order=data.raw["item-subgroup"]["py-alienlife-moon"].order or "f-f"},
        ["recipe-py-alienlife-ralesia"] = {order=data.raw["item-subgroup"]["py-alienlife-ralesia"].order or "f-g"},
        ["recipe-py-alienlife-fawogae"] = {order=data.raw["item-subgroup"]["py-alienlife-fawogae"].order or "f-h"},
        ["recipe-py-alienlife-tuuphra"] = {order=data.raw["item-subgroup"]["py-alienlife-tuuphra"].order or "f-i"},
        ["recipe-py-alienlife-kicalk"] = {order=data.raw["item-subgroup"]["py-alienlife-kicalk"].order or "f-j"},
        ["recipe-py-alienlife-yaedols"] = {order=data.raw["item-subgroup"]["py-alienlife-yaedols"].order or "f-k"},
        ["recipe-py-alienlife-rennea"] = {order=data.raw["item-subgroup"]["py-alienlife-rennea"].order or "f-l"},
        ["recipe-py-alienlife-yotoi"] = {order=data.raw["item-subgroup"]["py-alienlife-yotoi"].order or "f-m"},
        ["recipe-py-alienlife-navens"] = {order=data.raw["item-subgroup"]["py-alienlife-navens"].order or "f-n"},
        ["recipe-py-alienlife-bhoddos"] = {order=data.raw["item-subgroup"]["py-alienlife-bhoddos"].order or "f-o"},
        ["recipe-py-alienlife-grod"] = {order=data.raw["item-subgroup"]["py-alienlife-grod"].order or "f-p"},
        ["recipe-py-alienlife-cadaveric"] = {order=data.raw["item-subgroup"]["py-alienlife-cadaveric"].order or "f-q"},
        ["recipe-py-alienlife-guar"] = {order=data.raw["item-subgroup"]["py-alienlife-guar"].order or "f-r"},
        ["recipe-py-alienlife-mova"] = {order=data.raw["item-subgroup"]["py-alienlife-mova"].order or "f-s"},
    },
    ["combat"] = {
        ["tool"] = {order="1b"},
