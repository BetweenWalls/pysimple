...
local groups = {
    ...
    ["production"] = {
        ...
        ["extraction-machine"] = {order="zpy[general]-b[extraction]", items={"burner-mining-drill", "electric-mining-drill", "offshore-pump", "coal-mine", "iron-mine", "copper-mine", "aluminium-mine", "tin-mine", "lead-mine", "zinc-mine", "titanium-mine", "nickel-mine", "chromium-mine", "quartz-mine", "phosphate-mine-02", "rare-earth-mine", "salt-mine", "niobium-mine", "mo-mine", "phosphate-mine", "diamond-mine", "regolite-mine", "sulfur-mine", "geothermal-plant-mk01", "fracking-rig", "retorter", "uranium-mining-drill", "uranium-mine", "nexelit-mine"}},
        ...
        ["py-alternativeenergy-buildings-mk01"] = {order="zpy[mk01]-a[power]", items={"steam-turbine-mk01", "py-heat-exchanger", "neutron-absorber-mk01", "neutron-moderator-mk01", "nuclear-reactor-mk01", "nuclear-reactor-mox-mk01", "nuclear-reactor-mox-mk01-uncraft", "py-biomass-powerplant-mk01", "py-coal-powerplant-mk01", "py-gas-powerplant-mk01", "py-oil-powerplant-mk01", "solar-panel-mk01", "tidal-mk01", "vawt-turbine-mk01", "vawt-turbine-mk01-collision", "hawt-turbine-mk01", "hawt-turbine-mk01-collision", "hawt-turbine-mk01-blank", "multiblade-turbine-mk01", "multiblade-turbine-mk01-collision", "multiblade-turbine-mk01-blank", "gasturbinemk01", "power-house"}},
        ["py-alternativeenergy-buildings-mk02"] = {order="zpy[mk02]-a[power]", items={"steam-turbine-mk02", "py-heat-exchanger-mk02", "neutron-absorber-mk02", "neutron-moderator-mk02", "nuclear-reactor-mk02", "nuclear-reactor-mox-mk02", "nuclear-reactor-mox-mk02-uncraft", "py-biomass-powerplant-mk02", "py-coal-powerplant-mk02", "py-gas-powerplant-mk02", "py-oil-powerplant-mk02", "solar-panel-mk02", "tidal-mk02", "vawt-turbine-mk02", "vawt-turbine-mk02-collision", "hawt-turbine-mk02", "hawt-turbine-mk02-collision", "hawt-turbine-mk02-blank", "gasturbinemk02", "power-house-mk02"}},
        ["py-alternativeenergy-buildings-mk03"] = {order="zpy[mk03]-a[power]", items={"steam-turbine-mk03", "py-heat-exchanger-mk03", "neutron-absorber-mk03", "neutron-moderator-mk03", "nuclear-reactor-mk03", "nuclear-reactor-mox-mk03", "nuclear-reactor-mox-mk03-uncraft", "py-biomass-powerplant-mk03", "py-coal-powerplant-mk03", "py-gas-powerplant-mk03", "py-oil-powerplant-mk03", "solar-panel-mk03", "tidal-mk03", "vawt-turbine-mk03", "vawt-turbine-mk03-collision", "hawt-turbine-mk03", "hawt-turbine-mk03-collision", "hawt-turbine-mk03-blank", "multiblade-turbine-mk03", "multiblade-turbine-mk03-collision", "multiblade-turbine-mk03-blank", "gasturbinemk03", "power-house-mk03"}},
        ["py-alternativeenergy-buildings-mk04"] = {order="zpy[mk04]-a[power]", items={"steam-turbine-mk04", "py-heat-exchanger-mk04", "neutron-absorber-mk04", "neutron-moderator-mk04", "nuclear-reactor-mk04", "nuclear-reactor-mox-mk04", "nuclear-reactor-mox-mk04-uncraft", "py-biomass-powerplant-mk04", "py-coal-powerplant-mk04", "py-gas-powerplant-mk04", "py-oil-powerplant-mk04", "solar-panel-mk04", "tidal-mk04", "vawt-turbine-mk04", "vawt-turbine-mk04-collision", "hawt-turbine-mk04", "hawt-turbine-mk04-collision", "hawt-turbine-mk04-blank", "power-house-mk04"}},
        ["py-mining-mk01"] = {order="zpy[mk01]-b[extraction]", items={"soil-extractor-mk01", "clay-pit-mk01", "flora-collector-mk01", "flora-cultivator-mk01", "fluid-drill-mk01", "borax-mine", "antimony-drill-mk01", "ree-mining-drill-mk01", "oil-sand-extractor-mk01", "natural-gas-derrick-mk01", "oil-derrick-mk01", "tar-extractor-mk01", "coalbed-mk01", "pumpjack-mk01", "sand-extractor", "ground-borer", "spore-collector-mk01", "tholin-atm-mk01", "soil-extractor-mk01-legacy", "antimonium-drill-mk01", "ground-borer-legacy", "sand-extractor-legacy", "natural-gas-derrick-mk01-base", "oil-derrick-mk01-base", "tar-extractor-mk01-base"}}, -- pyblock only: flora-cultivator-mk01 (and mk02,mk03,mk04 versions)
        ["py-mining-mk02"] = {order="zpy[mk02]-b[extraction]", items={"soil-extractor-mk02", "clay-pit-mk02", "flora-collector-mk02", "flora-cultivator-mk02", "fluid-drill-mk02", "borax-mine-mk02", "antimony-drill-mk02", "ree-mining-drill-mk02", "oil-sand-extractor-mk02", "natural-gas-derrick-mk02", "oil-derrick-mk02", "tar-extractor-mk02", "coalbed-mk02", "pumpjack-mk02", "sand-extractor-mk02", "ground-borer-mk02", "spore-collector-mk02", "tholin-atm-mk02", "soil-extractor-mk02-legacy", "antimonium-drill-mk02", "ground-borer-mk02-legacy", "sand-extractor-mk02-legacy", "natural-gas-derrick-mk02-base", "oil-derrick-mk02-base", "tar-extractor-mk02-base"}},
        ["py-mining-mk03"] = {order="zpy[mk03]-b[extraction]", items={"soil-extractor-mk03", "clay-pit-mk03", "flora-collector-mk03", "flora-cultivator-mk03", "fluid-drill-mk03", "borax-mine-mk03", "antimony-drill-mk03", "ree-mining-drill-mk03", "oil-sand-extractor-mk03", "natural-gas-derrick-mk03", "oil-derrick-mk03", "tar-extractor-mk03", "coalbed-mk03", "pumpjack-mk03", "sand-extractor-mk03", "ground-borer-mk03", "spore-collector-mk03", "tholin-atm-mk03", "soil-extractor-mk03-legacy", "antimonium-drill-mk03", "ground-borer-mk03-legacy", "sand-extractor-mk03-legacy", "natural-gas-derrick-mk03-base", "oil-derrick-mk03-base", "tar-extractor-mk03-base"}},
        ["py-mining-mk04"] = {order="zpy[mk04]-b[extraction]", items={"soil-extractor-mk04", "clay-pit-mk04", "flora-collector-mk04", "flora-cultivator-mk04", "fluid-drill-mk04", "borax-mine-mk04", "antimony-drill-mk04", "ree-mining-drill-mk04", "oil-sand-extractor-mk04", "natural-gas-derrick-mk04", "oil-derrick-mk04", "tar-extractor-mk04", "coalbed-mk04", "pumpjack-mk04", "sand-extractor-mk04", "ground-borer-mk04", "spore-collector-mk04", "tholin-atm-mk04", "soil-extractor-mk04-legacy", "antimonium-drill-mk04", "ground-borer-mk04-legacy", "sand-extractor-mk04-legacy", "natural-gas-derrick-mk04-base", "oil-derrick-mk04-base", "tar-extractor-mk04-base"}},
        ...
        --["py-cp-buildings-mk00"] = {order="zpy[mk00]-d", items={"soil-extractor-mk00", "wpu-mk00", "automated-screener-mk00", "washer-mk00", "solid-separator-mk00", "ddc-mk00", "atomizer-mk00", "compost-plant-mk00"}}, -- pyblock only
        ...
        ["py-fusion-buildings-mk01"] = {order="zpy[mk01]-e", items={"wpu-mk01", "wpu-mk01-turd", "glassworks-mk01", "hpf", "washer", "evaporator", "carbon-filter", "pulp-mill-mk01", "solid-separator", "electrolyzer-mk01", "centrifuge-mk01", "vacuum-pump-mk01", "cooling-tower-mk01", "evaporator-legacy", "wpu-mk01-legacy"}},
        ["py-fusion-buildings-mk02"] = {order="zpy[mk02]-e", items={"wpu-mk02", "wpu-mk02-turd", "glassworks-mk02", "hpf-mk02", "washer-mk02", "evaporator-mk02", "carbon-filter-mk02", "pulp-mill-mk02", "solid-separator-mk02", "electrolyzer-mk02", "centrifuge-mk02", "vacuum-pump-mk02", "cooling-tower-mk02", "evaporator-mk02-legacy", "wpu-mk02-legacy"}},
        ["py-fusion-buildings-mk03"] = {order="zpy[mk03]-e", items={"wpu-mk03", "wpu-mk03-turd", "glassworks-mk03", "hpf-mk03", "washer-mk03", "evaporator-mk03", "carbon-filter-mk03", "pulp-mill-mk03", "solid-separator-mk03", "electrolyzer-mk03", "centrifuge-mk03", "vacuum-pump-mk03", "evaporator-mk03-legacy", "wpu-mk03-legacy"}},
        ["py-fusion-buildings-mk04"] = {order="zpy[mk04]-e", items={"wpu-mk04", "wpu-mk04-turd", "glassworks-mk04", "hpf-mk04", "washer-mk04", "evaporator-mk04", "carbon-filter-mk04", "pulp-mill-mk04", "solid-separator-mk04", "electrolyzer-mk04", "centrifuge-mk04", "vacuum-pump-mk04", "evaporator-mk04-legacy", "wpu-mk04-legacy"}},
        ...
        --["py-miscellaneous-buildings-mk01"] = {order="zpy[mk01]-h", items={"atomizer-mk01", "compost-plant-mk01", "compost-plant-mk01-turd", "bio-reactor-mk01", "advanced-bio-reactor-mk01-turd1", "advanced-bio-reactor-mk01-turd2", "advanced-bio-reactor-mk01-turd3", "biofactory-mk01", "micro-mine-mk01", "incubator-mk01", "genlab-mk01", "research-center-mk01"}},
        --["py-miscellaneous-buildings-mk02"] = {order="zpy[mk02]-h", items={"atomizer-mk02", "compost-plant-mk02", "compost-plant-mk02-turd", "bio-reactor-mk02", "advanced-bio-reactor-mk02-turd1", "advanced-bio-reactor-mk02-turd2", "advanced-bio-reactor-mk02-turd3", "biofactory-mk02", "micro-mine-mk02", "incubator-mk02", "genlab-mk02", "research-center-mk02"}},
    ...
    ["py-hightech"] = { -- renamed "intermediate products"
        ...
        ["py-nuclear-waste"] = {order="zpy-52"},
        ["py-intermediates-35"] = {order="zpy-53", items={"control-rod", "used-control-rod", "nuclear-fuel", "used-nuclear-fuel", "fuelrod-mk01", "fuelrod-mk02", "fuelrod-mk03", "fuelrod-mk04", "fuelrod-mk05", "mox-fuel-cell", "used-up-mox-fuel-cell", "uranium-fuel-cell", "depleted-uranium-fuel-cell", "uranium-fuel-cell-mk02", "used-up-uranium-fuel-cell-mk02", "uranium-fuel-cell-mk03", "used-up-uranium-fuel-cell-mk03", "uranium-fuel-cell-mk04", "used-up-uranium-fuel-cell-mk04", "uranium-fuel-cell-mk05", "used-up-uranium-fuel-cell-mk05"}},
    ...
    ["py-petroleum-handling"] = { -- renamed "fluids"
        ...
        ["py-fluids-4"] = {order="zpy-04", items={"water", "water-saline", "pressured-water", "subcritical-water", "geothermal-water", "waste-water", "muddy-sludge"}, recipes={{"muddy-sludge-void-electrolyzer"}, {"water-from-oxygen-and-hydrogen"}, {"waste-water-void"}, {"water-free"}, {"methanol-void-denitrification"}, {"filtration-dirty-water"}, {"sulfur-void-water"}, {"cooling-water"}, {"cooling-water-2"}, {"saline-water"}, {"gravel-saline-water"}, {"sodium-hydroxide-void"}, {"water-saline"}, {"water-saline-pumpjack"}, {"waste-water-recycle"}, {"frack-saline-water"}}},
        ...
        ["py-fluids-12"] = {order="zpy-12", items={"pitch", "middle-oil", "anthracene-oil", "naphthalene-oil", "carbolic-oil", "creosote", "tailings"}, recipes={{"tar-refining","zpy-item-00b"}, {"pitch-refining","zpy-item-00c"}, {"tar-refining-tops","zpy-item-02b"}, "tar-quenching", {"tar-to-carbolic"}, {"chitin-void"}}},
    ...
    ["py-alienlife"] = { -- renamed "life"
        ...
        ["py-veganism-mo"] = {order="bb-1-1"}, -- pyveganism only...
        ["py-veganism-e-coli"] = {order="bb-1-2"},
        ["py-veganism-fiicorum"] = {order="bb-1-3"},
        ["py-veganism-pemtenn"] = {order="bb-1-4"},
        ["py-veganism-proxae"] = {order="bb-1-5"},
        ["py-veganism-media"] = {order="bb-1-6"},
        ["py-veganism-burlap"] = {order="bb-1-7"},
        ["py-veganism-biomass"] = {order="bb-1-8"},
        ["py-veganism-filament"] = {order="dy2"},
        ["py-veganism-vrauks"] = {order="e-a"},
        ["py-veganism-vrauk"] = {order="e-a"},
        ["py-veganism-auog"] = {order="e-b"},
        ["py-veganism-cottongut"] = {order="e-c"},
        ["py-veganism-ulric"] = {order="e-d"},
        ["py-veganism-arqad"] = {order="e-e"},
        ["py-veganism-korlex"] = {order="e-f"},
        ["py-veganism-mukmoux"] = {order="e-g"},
        ["py-veganism-phagnot"] = {order="e-h"},
        ["py-veganism-arthurian"] = {order="e-i"},
        ["py-veganism-scrondrix"] = {order="e-j"},
        ["py-veganism-kmauts"] = {order="e-k"},
        ["py-veganism-dingrits"] = {order="e-l"},
        ["py-veganism-phadai"] = {order="e-m"},
        ["py-veganism-simik"] = {order="e-n"},
        ["py-veganism-vonix"] = {order="e-o"},
        ["py-veganism-zungror"] = {order="e-p"},
        ["py-veganism-xeno"] = {order="e-q"},
        ["py-veganism-antelope"] = {order="e-r"},
        ["py-veganism-zipir"] = {order="e-x[water]-1"},
        ["py-veganism-zipir1"] = {order="e-x[water]-1"},
        ["py-veganism-trits"] = {order="e-x[water]-2"},
        ["py-veganism-xyhiphoe"] = {order="e-x[water]-3"},
        ["py-veganism-dhilmos"] = {order="e-x[water]-4"},
        ["py-veganism-numal"] = {order="e-x[water]-5"},
        ["py-veganism-fish"] = {order="e-x[water]-6"},
        ["py-veganism-plants"] = {order="f"},
        ["py-veganism-cridren"] = {order="f-1"},
        ["py-veganism-sea-sponge"] = {order="f-2"},
        ["py-veganism-sponge"] = {order="f-3"},
        ["py-veganism-biosample"] = {order="f-a"},
        ["py-veganism-moss"] = {order="f-b"},
        ["py-veganism-seaweed"] = {order="f-c"},
        ["py-veganism-tree"] = {order="f-d"},
        ["py-veganism-sap"] = {order="f-e"},
        ["py-veganism-moon"] = {order="f-f"},
        ["py-veganism-calknut"] = {order="f-f2"},
        ["py-veganism-oil-palm"] = {order="f-f3"},
        ["py-veganism-oil-plants"] = {order="f-f4"},
        ["py-veganism-ralesia"] = {order="f-g"},
        ["py-veganism-fawogae"] = {order="f-h"},
        ["py-veganism-sugar-cane"] = {order="f-h2"},
        ["py-veganism-carbohydrates"] = {order="f-h2"},
        ["py-veganism-tuuphra"] = {order="f-i"},
        ["py-veganism-kicalk"] = {order="f-j"},
        ["py-veganism-yaedols"] = {order="f-k"},
        ["py-veganism-rennea"] = {order="f-l"},
        ["py-veganism-yotoi"] = {order="f-m"},
        ["py-veganism-navens"] = {order="f-n"},
        ["py-veganism-bhoddos"] = {order="f-o"},
        ["py-veganism-grod"] = {order="f-p"},
        ["py-veganism-cadaveric"] = {order="f-q"},
        ["py-veganism-guar"] = {order="f-r"},
        ["py-veganism-mova"] = {order="f-s"},
        ["py-veganism-miscellaneous"] = {order="x"},
    },
    ["combat"] = {
        ["tool"] = {order="1b"},
    ...
    ["environment"] = {
        ...
        --["cliffs"] = {order="a"},
        ["trees"] = {order="aa", items={"driftwood"}}, -- pyblock only
        --["grass"] = {order="b"},
        ...
        ["mineable-fluids"] = {order="i", items={"geothermal-crack", "bitumen-seep", "tar-patch", "natural-gas-mk01", "natural-gas-mk02", "natural-gas-mk03", "natural-gas-mk04", "oil-mk01", "oil-mk02", "oil-mk03", "oil-mk04"}},
        ...
        for subgroup,details in pairs(subgroups) do
            ...
            if data.raw["item-subgroup"][subgroup] then
                ...
                if data.raw["item-subgroup"]["recipe-"..subgroup] then
                    data.raw["item-subgroup"]["recipe-"..subgroup].order = data.raw["item-subgroup"][subgroup].order
                    data.raw["item-subgroup"]["recipe-"..subgroup].group = data.raw["item-subgroup"][subgroup].group
                end
...
if settings.startup["pysimple-recipe-menu"].value then
    ...
    for name,recipe in pairs(data.raw.recipe) do
        if recipe.results and recipe.results[1] and recipe.results[1].name == "biomass" then
            ...
            local div = 1
            if ingredient.type == "fluid" then div = 50 end
            if res.amount then
                data.raw.recipe[name].order = "zpy-recipe-"..tostring(math.max(res.amount / (1000 * ingredient.amount/div), 0.0001))
            else
                data.raw.recipe[name].order = "zpy-recipe-"..tostring(math.max((res.probability or 1) * (res.amount_min + res.amount_max) / (2000 * ingredient.amount/div), 0.0001))
            end
        end
    end
