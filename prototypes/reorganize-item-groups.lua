...
local groups = {
    ...
    ["production"] = {
        ...
        ["py-alternativeenergy-buildings-mk01"] = {order="zpy[mk01]-a[power]", items={{"steam-turbine-mk01","1"}, {"py-heat-exchanger","2"}, "solar-panel-mk01", "tidal-mk01", "vawt-turbine-mk01", "hawt-turbine-mk01", "multiblade-turbine-mk01", "gasturbinemk01", "vawt-turbine-mk01-collision", "hawt-turbine-mk01-collision", "multiblade-turbine-mk01-collision", "multiblade-turbine-mk01-blank"}},
        ["py-alternativeenergy-buildings-mk02"] = {order="zpy[mk02]-a[power]", items={{"steam-turbine-mk02","1"}, {"py-heat-exchanger-mk02","2"}, "solar-panel-mk02", "tidal-mk02", "vawt-turbine-mk02", "hawt-turbine-mk02", "gasturbinemk02", "vawt-turbine-mk02-collision", "hawt-turbine-mk02-collision"}},
        ...
        ["py-alternativeenergy-buildings-mk04"] = {order="zpy[mk04]-a[power]", items={{"steam-turbine-mk04","1"}, {"py-heat-exchanger-mk04","2"}, "solar-panel-mk04", "tidal-mk04", "vawt-turbine-mk04", "hawt-turbine-mk04", "vawt-turbine-mk04-collision", "hawt-turbine-mk04-collision"}},
    ...
    ["py-petroleum-handling"] = { -- renamed "fluids"
        ...
        ["py-fluids-27b"] = {order="zpy-27b", items={"ethane", "dichloroethane", "ethylenediamine"}},
    ...
    ["py-alienlife"] = { -- renamed "life"
        ...
        ["py-alienlife-vonix"] = {items={"blood-vonix", "brain-vonix", "fat-vonix", "guts-vonix", "meat-vonix", "skin-vonix", "vonix-eggs", "vonix-cub", "vonix", "vonix-mk02", "vonix-mk03", "vonix-mk04", "venom-gland"}, recipes={{"full-render-vonix","1"}, {"ex-blo-von"}, {"ex-bra-von"}, {"ex-fat-von"}, {"ex-gut-von","af"}, {"ex-me-von"}, {"ex-ski-von"}}},
        ...
        ["recipe-py-alienlife-ulric"] = {order=data.raw["item-subgroup"]["py-alienlife-ulric"].order or "e-a"},
    ...
    for group,subgroups in pairs(groups) do
        for subgroup,details in pairs(subgroups) do
            if not data.raw["item-subgroup"][subgroup] then
                -- TODO: Could this cause any issues with mods such as PyBlock that expect to create their own subgroups?
